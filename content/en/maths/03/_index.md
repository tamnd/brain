...
### Chapter 18. Homotopy Type Theory (Overview)
...
20.1 Logic programming
20.2 Type systems
20.3 Verification
20.4 Model checking
20.5 Program synthesis

### Chapter 21. Complexity Theory

21.1 Time and space complexity
21.2 Complexity classes (P, NP, etc.)
...
A. Symbol and notation reference
B. Standard logical systems
C. Key theorems summary
D. Proof templates
E. Cross-reference to other MSC branches

---

This volume provides the formal backbone of mathematics. It defines what can be proved, computed, and represented, and clarifies the limits of formal reasoning.
