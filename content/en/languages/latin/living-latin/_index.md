---
title: "Living Latin (Active Latin Movement)"
description: "The Active Latin / Living Latin movement: speaking Latin as a living language, key figures (Luke Ranieri, Justin Slocum Bailey, Luigi Miraglia), programs (Paideia, Vivarium Novum, SALVI)."
tags: ["latin", "living-latin", "active-latin", "paideia", "vivarium-novum", "salvi", "speaking"]
cascade:
  type: docs
...
1. More input per unit time (you hear others speak while you interact)
2. Forced output that reveals and closes grammatical gaps
...
Swedish Latinist who co-runs [latinitium.com](https://latinitium.com). Pettersson produces written articles on Latin learning strategy, audio recordings of Latin texts, the Latinitium Podcast, and extensive resources for learners. His approach is notably evidence-based — he frequently discusses second-language acquisition research in the context of Latin learning.
...
**Website**: [paideiainstitute.org](https://www.paideiainstitute.org)
**Founded**: 2010, New York City
**Type**: Non-profit educational organization focused on classical culture
...
**Website**: [vivariumnovum.net](https://vivariumnovum.net)
**Location**: Frascati (Castelli Romani), 25 km southeast of Rome
**Director**: Luigi Miraglia
**Founded**: 1993
...
**Website**: [latin.org](https://www.latin.org)
**Founded**: 1990s
**Type**: North American non-profit for Living Latin Studies
...
**Organizers**: Terence Tunberg and Milena Minkova
**Founded**: 1996
**Type**: Annual week-long spoken Latin seminar for scholars
...
**Host**: Dickinson College, Carlisle, Pennsylvania
**Type**: Annual week-long spoken Latin event
...
**Website**: [scholalatina.eu](https://www.scholalatina.eu)
**Type**: Online school for Latin as a living language
...
| LLPSI Colloquia Personarum | Textbook supplement | Print | ~$20 | Essential companion to LLPSI |
...
- SALVI event information: [latin.org](https://www.latin.org)
- Vivarium Novum program details: [vivariumnovum.net](https://vivariumnovum.net)
