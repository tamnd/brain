---
title: "Advanced Latin Texts"
description: "Latin texts for advanced level: Cicero's speeches and philosophy, Virgil's Aeneid, Livy, Horace, Tacitus, Seneca — with difficulty ratings and best starting points."
tags: ["latin", "texts", "advanced", "cicero", "virgil", "livy", "horace", "tacitus", "seneca"]
cascade:
  type: docs
...
> *Aurea purpuream subnectit fibula vestem* — a golden clasp fastens the purple cloak
> A(adj) B(adj) verb A(noun) B(noun)
...
**Recommendation**: *De Amicitia* → *De Officiis* → *Tusculan Disputations* is a natural philosophical progression.
