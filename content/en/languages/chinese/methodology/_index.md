...
description: "Evidence-based roadmap for learning Mandarin Chinese: recommended order, time estimates, SRS strategy, comprehensible input, and common mistakes."
tags: ["chinese", "methodology", "learning", "mandarin", "srs"]
cascade:
  type: docs
...
4. Grammar via examples: reference [Chinese Grammar Wiki](https://resources.allsetlearning.com/chinese/grammar/) for A1–A2 patterns
...
### Setup
1. Download [Anki](https://apps.ankiweb.net/) (free on desktop/Android; paid on iOS)
...
|-------|---------|--------|
| A1–A2 | [Comprehensible Chinese](https://www.youtube.com/@ComprehensibleChinese) | YouTube (Mandarin-only) |
| A2–B1 | [Mandarin Companion](https://mandarincompanion.com/) | Graded readers |
| B1–B2 | [Du Chinese](https://duchinese.net/) | App: graded stories + audio |
| B1–B2 | [The Chairman's Bao](https://thechairmansbao.com/) | Graded news articles |
| B2–C1 | [Mandarin Corner](https://mandarincorner.org/) | Videos + full transcripts |
