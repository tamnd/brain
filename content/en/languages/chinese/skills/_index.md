---
title: "Skills"
description: "All six core Mandarin Chinese skills: Tones, Pinyin, Hanzi, Grammar, Listening, and Speaking — with guides, resources, and a recommended learning order."
tags: ["chinese", "mandarin", "skills", "tones", "pinyin", "hanzi", "grammar", "listening", "speaking"]
cascade:
  type: docs
...
|-------|-------------|------------|------|
| [Tones](tones/) | Mandarin uses 4 tones + a neutral tone. Same syllable, different pitch = different word. | High | [tones/](tones/) |
...
**Why Grammar via sentences, not rules?** Mandarin grammar rules are best internalized through examples. Use the [Chinese Grammar Wiki](https://resources.allsetlearning.com/chinese/grammar/) to look up patterns you encounter, not as a textbook to read front-to-back.
