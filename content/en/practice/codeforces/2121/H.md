...
description: "For every position i, we are not given a fixed value. Instead, we may choose any integer inside an interval [li, ri]. For each prefix length k, consider all arrays $$a1,a2,dots,ak$$ such that $$li le ai le ri."
date: "2026-06-08T03:50:08+07:00"
tags: ["codeforces", "competitive-programming", "binary-search", "brute-force", "data-structures", "dp", "implementation", "sortings"]
...
[CF 2121H - Ice Baby](https://codeforces.com/problemset/problem/2121/H)
...
For every position `i`, we are not given a fixed value. Instead, we may choose any integer inside an interval `[l_i, r_i]`.

For each prefix length `k`, consider all arrays
