...
description: "We are given an array $b$ that was produced from an unknown permutation $a$ of the numbers $1$ through $n$. For every position $i$, $$bi=leftlfloor frac{i}{ai}rightrfloor."
date: "2026-06-09T21:47:53+07:00"
...
[CF 1701D - Permutation Restoration](https://codeforces.com/problemset/problem/1701/D)
...
We are given an array $b$ that was produced from an unknown permutation $a$ of the numbers $1$ through $n$. For every position $i$,

$$b_i=\left\lfloor \frac{i}{a_i}\right\rfloor.$$
