...
description: "We are asked to compute a sum over triples of integers drawn from a given array. Specifically, for a sequence of non-negative integers $x1, x2, ldots, xn$, the target value is $$sum{i=1}^n sum{j=1}^n sum{k=1}^n (xi & xj) cdot (xj , where $&$ is the bitwise AND and $ The…"
date: "2026-06-11T01:44:54+07:00"
...
[CF 1466E - Apollo versus Pan](https://codeforces.com/problemset/problem/1466/E)
...
We are asked to compute a sum over triples of integers drawn from a given array. Specifically, for a sequence of non-negative integers $x_1, x_2, \ldots, x_n$, the target value is
