...
description: "We are given an array and may permute its elements however we like. After choosing an ordering, we build a new array consisting of sums of neighboring elements: $$b=[a1+a2, a2+a3, ldots, a{n-1}+an]."
date: "2026-06-09T09:11:13+07:00"
...
[CF 1806B - Mex Master](https://codeforces.com/problemset/problem/1806/B)
...
We are given an array and may permute its elements however we like.

After choosing an ordering, we build a new array consisting of sums of neighboring elements:

$$b=[a_1+a_2,\ a_2+a_3,\ \ldots,\ a_{n-1}+a_n].$$
