...
$$\langle p_x\rangle_{\rm in}
=
\frac{\displaystyle\int_0^\infty m v_x^2
e^{-m v_x^2/(2k_B T_1)}\,dv_x}
{\displaystyle\int_0^\infty v_x
e^{-m v_x^2/(2k_B T_1)}\,dv_x}
=
\sqrt{\frac{\pi m k_B T_1}{2}}.$$

Multiplying the incident flux by the average momentum per incident molecule gives

$$J_{\rm in}
=
n\sqrt{\frac{k_B T_1}{2\pi m}}
\sqrt{\frac{\pi m k_B T_1}{2}}
=
\frac12 n k_B T_1.$$
...
$$J_{\rm out}
=
\frac12 n\sqrt{\frac{T_1}{T}}\,k_B T
=
\frac12 n k_B\sqrt{T_1T}.$$
...
\frac12 n k_B\sqrt{T_1T}
=
\frac12 n k_B\left(T_1+\sqrt{T_1T}\right).$$
