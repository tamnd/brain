...
description: "We are given an array $a$, but we do not know its values directly. Instead, we know that we may choose a number $x$, XOR every element of $a$ with $x$, and obtain a new array $b$, where $$bi = ai oplus x."
date: "2026-06-09T09:16:00+07:00"
...
[CF 1805A - We Need the Zero](https://codeforces.com/problemset/problem/1805/A)
...
We are given an array $a$, but we do not know its values directly. Instead, we know that we may choose a number $x$, XOR every element of $a$ with $x$, and obtain a new array $b$, where
