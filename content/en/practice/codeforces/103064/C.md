---
title: "CF 103064C - Baba is You"
description: "Let $(a{ij})$ be an $mtimes n$ contingency table with fixed row sums $sum{j=1}^n a{ij}=ri quad (1le ile m)$ and column sums $sum{i=1}^m a{ij}=cj quad (1le jle n),$ where $sumi ri=sumj cj$."
...
[CF 103064C - Baba is You](https://codeforces.com/problemset/problem/103064/C)
