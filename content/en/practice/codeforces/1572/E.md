---
title: "CF 1572E - Polygon"
description: "We must compute $$(cdots((x1otimes x2)otimes x3)otimescdotsotimes x{10^6}),$$ with $$xk=1.111111.$$ Let $$sk=(cdots((x1otimes x2)otimescdots)otimes xk).$$ Since every addition is rounded to eight significant decimal digits, the recurrence is $$sk=operatorname{fl}(s{k-1}+1." date: "2026-06-10T11:18:04+07:00" tags: ["codeforces", "competitive-programming", "binary-search", "dp", "geometry"] categories: ["algorithms"] codeforces_contest: 1572 codeforces_index: "E" codeforces_contest_name: "Codeforces Round 743 (Div. 1)" rating: 3000 weight: 1572 solve_time_s: 150 verified: false draft: false --- [CF 1572E - Polygon](https://codeforces.com/problemset/problem/1572/E) **Rating:** 3000   **Tags:** binary search, dp, geometry   **Solve time:** 2m 30s   **Verified:** no   ## Solution ## (a) We must compute$$(\cdots((x_1\otimes x_2)\otimes x_3)\otimes\cdots\otimes x_{10^6}),$$
with
$$x_k=1.111111.$$
Let
