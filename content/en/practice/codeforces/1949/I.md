...
description: "Each disk has a fixed center and an initial radius. Some pairs of disks are tangent, meaning they touch at exactly one point. Because the disks never overlap with positive area, every tangent pair satisfies $$text{distance between centers} = ri + rj."
date: "2026-05-31T00:00:00+07:00"
tags: ["codeforces", "competitive-programming", "dfs-and-similar", "geometry", "graph-matchings", "graphs"]
...
[CF 1949I - Disks](https://codeforces.com/problemset/problem/1949/I)
...
Each disk has a fixed center and an initial radius. Some pairs of disks are tangent, meaning they touch at exactly one point. Because the disks never overlap with positive area, every tangent pair satisfies

$$\text{distance between centers} = r_i + r_j.$$
