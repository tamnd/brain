...
description: "By Exercise 20, the hypotheses $$hat q v{n-2} le b hat r + u{n-2}, qquad hat q < b, qquad v{n-1} 0$$ imply that $$hat q = q quad text{or} quad hat q = q-1.$$ Since the present exercise assumes $hat q ne q$, we have necessarily $$hat q = q-1.$$ Let $$r = u - qv = u bmod v." date: "2026-06-10T13:51:42+07:00" tags: ["codeforces", "competitive-programming", "data-structures", "dp"] categories: ["algorithms"] codeforces_contest: 1545 codeforces_index: "E1" codeforces_contest_name: "Codeforces Round 732 (Div. 1)" rating: 3500 weight: 1545 solve_time_s: 163 verified: false draft: false --- [CF 1545E1 - AquaMoon and Time Stop (easy version)](https://codeforces.com/problemset/problem/1545/E1) **Rating:** 3500   **Tags:** data structures, dp   **Solve time:** 2m 43s   **Verified:** no   ## Solution ## Solution By Exercise 20, the hypotheses$$\hat q v_{n-2} \le b \hat r + u_{n-2}, \qquad \hat q < b, \qquad v_{n-1} > 0$$
imply that
