...
description: "--- [LeetCode Problem 237](https://leetcode.com/problems/delete-node-in-a-linked-list/) Difficulty: 🟡 Medium Topics: Linked List This problem asks us to delete a node from a singly linked list, but with an unusual restriction: we are not given access to the head of the list."
