...
description: "--- [LeetCode Problem 276](https://leetcode.com/problems/paint-fence/) Difficulty: 🟡 Medium Topics: Dynamic Programming The problem gives us a fence with n posts and k available colors. Every fence post must be painted using exactly one of those colors."
