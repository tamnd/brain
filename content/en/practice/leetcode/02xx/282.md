...
description: "The problem gives us a numeric string num and an integer target. We must insert binary operators, specifically '+', '-', and '', between the digits of the string so that the resulting mathematical expression evaluates exactly to target."
...
[LeetCode Problem 282](https://leetcode.com/problems/expression-add-operators/)
