...
description: "--- [LeetCode Problem 259](https://leetcode.com/problems/3sum-smaller/) Difficulty: 🟡 Medium Topics: Array, Two Pointers, Binary Search, Sorting The problem asks us to count how many distinct index triplets (i, j, k) satisfy two conditions: 1."
