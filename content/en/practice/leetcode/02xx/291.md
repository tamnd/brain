...
description: "--- [LeetCode Problem 291](https://leetcode.com/problems/word-pattern-ii/) Difficulty: 🟡 Medium Topics: Hash Table, String, Backtracking The problem asks us to determine whether a given string s can be formed by substituting each character in a pattern with a non-empty string…"
