...
description: "--- [LeetCode Problem 287](https://leetcode.com/problems/find-the-duplicate-number/) Difficulty: 🟡 Medium Topics: Array, Two Pointers, Binary Search, Bit Manipulation The problem gives us an integer array nums of length n + 1, where every value is guaranteed to be in the range…"
