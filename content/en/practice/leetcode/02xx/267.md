...
description: "--- [LeetCode Problem 267](https://leetcode.com/problems/palindrome-permutation-ii/) Difficulty: 🟡 Medium Topics: Hash Table, String, Backtracking The problem asks us to generate every unique palindrome that can be formed by rearranging the characters of a given string."
...
[LeetCode Problem 267](https://leetcode.com/problems/palindrome-permutation-ii/)
