...
description: "--- [LeetCode Problem 256](https://leetcode.com/problems/paint-house/) Difficulty: 🟡 Medium Topics: Array, Dynamic Programming The problem gives us a row of houses, where each house must be painted using exactly one of three colors: red, blue, or green."
