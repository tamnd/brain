...
description: "This problem asks us to generate all unique combinations of exactly k distinct numbers chosen from the range 1 to 9 such that their sum equals n. Each number can only be used once in a combination. This means combinations like [1,1,5] are invalid because the number 1 is repeated."
