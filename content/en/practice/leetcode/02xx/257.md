...
description: "--- [LeetCode Problem 257](https://leetcode.com/problems/binary-tree-paths/) Difficulty: 🟢 Easy Topics: String, Backtracking, Tree, Depth-First Search, Binary Tree The problem asks us to return every path from the root of a binary tree to each leaf node."
