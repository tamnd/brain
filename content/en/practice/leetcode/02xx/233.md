...
description: "Given a non-negative integer n, we must count how many times the digit 1 appears in every number from 0 through n, inclusive. The important detail is that we are not counting how many numbers contain the digit 1."
