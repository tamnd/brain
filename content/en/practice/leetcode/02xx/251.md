...
description: "The problem asks us to design an iterator that traverses a two dimensional array as though it were a single flat sequence. Instead of returning nested lists, the iterator should expose elements one at a time through two methods, next() and hasNext()."
