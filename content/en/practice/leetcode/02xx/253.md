...
description: "--- [LeetCode Problem 253](https://leetcode.com/problems/meeting-rooms-ii/) Difficulty: 🟡 Medium Topics: Array, Two Pointers, Greedy, Sorting, Heap (Priority Queue), Prefix Sum The problem gives us a list of meeting intervals where each interval is represented as [start, end]."
