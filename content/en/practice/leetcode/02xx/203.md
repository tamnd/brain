...
description: "--- [LeetCode Problem 203](https://leetcode.com/problems/remove-linked-list-elements/) Difficulty: 🟢 Easy Topics: Linked List, Recursion The problem asks us to remove every node from a singly linked list whose value is equal to a given integer val."
