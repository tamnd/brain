...
description: "--- [LeetCode Problem 252](https://leetcode.com/problems/meeting-rooms/) Difficulty: 🟢 Easy Topics: Array, Sorting The problem provides a list of meeting intervals, where each interval is represented as [start, end]. Each pair describes the start time and end time of a meeting."
