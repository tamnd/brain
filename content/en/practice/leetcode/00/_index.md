...
|---|---|---|---|
| 1 | [LeetCode 1: Two Sum](0001.md) | Easy | A clear explanation of the Two Sum problem using brute force first, then an optimized hash map solution. |
| 2 | [LeetCode 2: Add Two Numbers](0002.md) | Medium | A detailed explanation of the Add Two Numbers linked list problem, including digit-by-digit addition, carry handling, and linked list construction. |
| 3 | [LeetCode 3: Longest Substring Without Repeating Characters](0003.md) | Medium | A clear explanation of the longest substring problem using sliding window and a hash set. |
| 4 | [LeetCode 4: Median of Two Sorted Arrays](0004.md) | Hard | A detailed explanation of finding the median of two sorted arrays using binary search over partitions. |
| 5 | [LeetCode 5: Longest Palindromic Substring](0005.md) | Medium | A detailed explanation of finding the longest palindromic substring using expand-around-center. |
| 6 | [LeetCode 6: Zigzag Conversion](0006.md) | Medium | A detailed explanation of converting a string into a zigzag pattern using row simulation. |
| 7 | [LeetCode 7: Reverse Integer](0007.md) | Medium | A detailed explanation of reversing a signed 32-bit integer while handling overflow correctly. |
| 8 | [LeetCode 8: String to Integer (atoi)](0008.md) | Medium | A detailed explanation of parsing a string into a 32-bit signed integer with whitespace, sign, digit reading, and clamping rules. |
| 9 | [LeetCode 9: Palindrome Number](0009.md) | Easy | A detailed explanation of checking whether an integer is a palindrome using digit operations without converting it to a string. |
| 10 | [LeetCode 10: Regular Expression Matching](0010.md) | Hard | A detailed explanation of matching a full string against a simplified regular expression with dot and star using dynamic programming. |
| 11 | [LeetCode 11: Container With Most Water](0011.md) | Medium | A detailed explanation of finding the maximum water container area using two pointers. |
| 12 | [LeetCode 12: Integer to Roman](0012.md) | Medium | A detailed explanation of converting an integer into a Roman numeral using a fixed value-symbol table and greedy subtraction. |
| 13 | [LeetCode 13: Roman to Integer](0013.md) | Easy | A detailed explanation of converting a Roman numeral string into an integer using symbol values and the subtraction rule. |
| 14 | [LeetCode 14: Longest Common Prefix](0014.md) | Easy | A detailed explanation of finding the longest common prefix among an array of strings by comparing characters column by column. |
| 15 | [LeetCode 15: 3Sum](0015.md) | Medium | A detailed explanation of finding all unique triplets that sum to zero using sorting and two pointers. |
| 16 | [LeetCode 16: 3Sum Closest](0016.md) | Medium | A detailed explanation of finding the sum of three integers closest to a target using sorting and two pointers. |
| 17 | [LeetCode 17: Letter Combinations of a Phone Number](0017.md) | Medium | A detailed explanation of generating all possible phone keypad letter combinations using backtracking. |
| 18 | [LeetCode 18: 4Sum](0018.md) | Medium | A detailed explanation of finding all unique quadruplets that sum to a target using sorting and two pointers. |
| 19 | [LeetCode 19: Remove Nth Node From End of List](0019.md) | Medium | A detailed explanation of removing the nth node from the end of a singly linked list using two pointers and a dummy node. |
| 20 | [LeetCode 20: Valid Parentheses](0020.md) | Easy | A detailed explanation of checking whether a bracket string is valid using a stack. |
| 21 | [LeetCode 21: Merge Two Sorted Lists](0021.md) | Easy | A detailed explanation of merging two sorted linked lists using a dummy node and pointer splicing. |
| 22 | [LeetCode 22: Generate Parentheses](0022.md) | Medium | A detailed explanation of generating all well-formed parentheses strings using backtracking. |
| 23 | [LeetCode 23: Merge k Sorted Lists](0023.md) | Hard | A detailed explanation of merging k sorted linked lists using a min heap. |
| 24 | [LeetCode 24: Swap Nodes in Pairs](0024.md) | Medium | A detailed explanation of swapping every two adjacent nodes in a linked list using pointer manipulation. |
| 25 | [LeetCode 25: Reverse Nodes in k-Group](0025.md) | Hard | A detailed explanation of reversing linked-list nodes in groups of k using pointer manipulation and constant extra space. |
| 26 | [LeetCode 26: Remove Duplicates from Sorted Array](0026.md) | Easy | A clear explanation of removing duplicates from a sorted array in place using two pointers. |
| 27 | [LeetCode 27: Remove Element](0027.md) | Easy | A clear explanation of removing all occurrences of a value from an array in place using a write pointer. |
| 28 | [LeetCode 28: Find the Index of the First Occurrence in a String](0028.md) | Easy | A clear explanation of finding the first occurrence of one string inside another using direct string matching. |
| 29 | [LeetCode 29: Divide Two Integers](0029.md) | Medium | A clear explanation of integer division without using multiplication, division, or modulo, using repeated doubling with bit shifts. |
| 30 | [LeetCode 30: Substring with Concatenation of All Words](0030.md) | Hard | A clear explanation of finding all starting indices where a substring is formed by concatenating every word exactly once. |
| 31 | [LeetCode 31: Next Permutation](0031.md) | Medium | A clear explanation of finding the next lexicographically greater permutation in place using a right-to-left scan. |
| 32 | [LeetCode 32: Longest Valid Parentheses](0032.md) | Hard | A clear explanation of finding the longest well-formed parentheses substring using a stack of indices. |
| 33 | [LeetCode 33: Search in Rotated Sorted Array](0033.md) | Medium | A clear explanation of searching a rotated sorted array in logarithmic time using modified binary search. |
| 34 | [LeetCode 34: Find First and Last Position of Element in Sorted Array](0034.md) | Medium | A clear explanation of finding the first and last index of a target in a sorted array using two binary searches. |
| 35 | [LeetCode 35: Search Insert Position](0035.md) | Easy | A clear explanation of finding the index of a target, or where it should be inserted, using binary search. |
| 36 | [LeetCode 36: Valid Sudoku](0036.md) | Medium | A clear explanation of checking whether a partially filled Sudoku board is valid using hash sets. |
| 37 | [LeetCode 37: Sudoku Solver](0037.md) | Hard | A clear explanation of solving a Sudoku board using backtracking and constraint checking. |
...
| 41 | [LeetCode 41: First Missing Positive](0041.md) | Hard | A clear explanation of the First Missing Positive problem using in-place index placement to achieve O(n) time and O(1) extra space. |
| 42 | [LeetCode 42: Trapping Rain Water](0042.md) | Hard | A clear explanation of the Trapping Rain Water problem using left and right boundaries, then an optimized two-pointer solution. |
| 43 | [LeetCode 43: Multiply Strings](0043.md) | Medium | A clear explanation of Multiply Strings using grade-school multiplication with digit arrays. |
| 44 | [LeetCode 44: Wildcard Matching](0044.md) | Hard | A clear explanation of Wildcard Matching using dynamic programming over string and pattern prefixes. |
| 45 | [LeetCode 45: Jump Game II](0045.md) | Medium | A clear explanation of Jump Game II using a greedy range expansion approach to find the minimum number of jumps. |
| 46 | [LeetCode 46: Permutations](0046.md) | Medium | A clear explanation of Permutations using depth-first search and backtracking. |
| 47 | [LeetCode 47: Permutations II](0047.md) | Medium | A clear explanation of Permutations II using sorting, depth-first search, and duplicate-skipping backtracking. |
| 48 | [LeetCode 48: Rotate Image](0048.md) | Medium | A clear explanation of Rotate Image using in-place matrix transpose and row reversal. |
| 49 | [LeetCode 49: Group Anagrams](0049.md) | Medium | A clear explanation of Group Anagrams using a hash map keyed by each word's sorted character signature. |
| 50 | [LeetCode 50: Pow(x, n)](0050.md) | Medium | A clear explanation of Pow(x, n) using binary exponentiation to compute powers in logarithmic time. |
