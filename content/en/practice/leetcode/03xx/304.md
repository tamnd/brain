...
description: "--- [LeetCode Problem 304](https://leetcode.com/problems/range-sum-query-2d-immutable/) Difficulty: 🟡 Medium Topics: Array, Design, Matrix, Prefix Sum The problem asks us to design a data structure that can efficiently answer multiple rectangular sum queries on a fixed 2D matrix."
