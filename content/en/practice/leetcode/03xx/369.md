...
description: "--- [LeetCode Problem 369](https://leetcode.com/problems/plus-one-linked-list/) Difficulty: 🟡 Medium Topics: Linked List, Math The problem requires us to add one to a non-negative integer that is represented as a singly-linked list."
