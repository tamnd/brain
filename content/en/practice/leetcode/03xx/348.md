...
description: "--- [LeetCode Problem 348](https://leetcode.com/problems/design-tic-tac-toe/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Design, Matrix, Simulation The problem asks us to design a data structure that simulates an n x n Tic-Tac-Toe game between two players."
