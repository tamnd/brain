...
description: "--- [LeetCode Problem 382](https://leetcode.com/problems/linked-list-random-node/) Difficulty: 🟡 Medium Topics: Linked List, Math, Reservoir Sampling, Randomized The problem gives us the head of a singly linked list and asks us to return a random node value such that every node…"
