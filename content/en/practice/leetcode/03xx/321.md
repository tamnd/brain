...
description: "--- [LeetCode Problem 321](https://leetcode.com/problems/create-maximum-number/) Difficulty: 🔴 Hard Topics: Array, Two Pointers, Stack, Greedy, Monotonic Stack This problem asks us to build the lexicographically largest possible number of length k using digits taken from two…"
...
[LeetCode Problem 321](https://leetcode.com/problems/create-maximum-number/)
