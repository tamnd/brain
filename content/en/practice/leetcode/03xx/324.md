...
description: "--- [LeetCode Problem 324](https://leetcode.com/problems/wiggle-sort-ii/) Difficulty: 🟡 Medium Topics: Array, Divide and Conquer, Greedy, Sorting, Quickselect The problem asks us to rearrange an array so that it follows a strict alternating pattern: - nums[0] < nums[1] - nums[1]…"
