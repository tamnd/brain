...
description: "--- [LeetCode Problem 378](https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/) Difficulty: 🟡 Medium Topics: Array, Binary Search, Sorting, Heap (Priority Queue), Matrix The problem gives us an n x n matrix where both rows and columns are sorted in ascending…"
