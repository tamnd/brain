...
description: "The problem asks us to determine whether a given positive integer num is a perfect square without using built in square root functions such as sqrt(). A perfect square is a number that can be written as: where k is an integer."
