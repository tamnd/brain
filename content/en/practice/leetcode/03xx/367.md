...
description: "--- [LeetCode Problem 367](https://leetcode.com/problems/valid-perfect-square/) Difficulty: 🟢 Easy Topics: Math, Binary Search The problem asks us to determine whether a given positive integer num is a perfect square without using built in square root functions such as sqrt()."
