...
description: "The problem gives us an initially empty m x n grid where every cell starts as water. We are then given a sequence of operations in positions, where each operation turns a specific cell from water into land."
