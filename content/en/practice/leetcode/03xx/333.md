...
description: "--- [LeetCode Problem 333](https://leetcode.com/problems/largest-bst-subtree/) Difficulty: 🟡 Medium Topics: Dynamic Programming, Tree, Depth-First Search, Binary Search Tree, Binary Tree The problem gives us the root of an arbitrary binary tree and asks us to find the size of…"
