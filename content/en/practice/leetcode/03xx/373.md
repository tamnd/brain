...
description: "--- [LeetCode Problem 373](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/) Difficulty: 🟡 Medium Topics: Array, Heap (Priority Queue) The problem gives us two sorted integer arrays, nums1 and nums2, and asks us to return the k pairs with the smallest sums."
...
[LeetCode Problem 373](https://leetcode.com/problems/find-k-pairs-with-smallest-sums/)
