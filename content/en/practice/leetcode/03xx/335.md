...
description: "--- [LeetCode Problem 335](https://leetcode.com/problems/self-crossing/) Difficulty: 🔴 Hard Topics: Array, Math, Geometry The problem describes a path traced on a two-dimensional grid. We begin at the origin (0, 0) and move according to the values in the distance array."
