...
description: "This problem asks us to construct a new string from the input string s such that every distinct character appears exactly once, while also ensuring that the final result is the smallest possible in lexicographical order."
