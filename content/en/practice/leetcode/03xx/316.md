...
description: "--- [LeetCode Problem 316](https://leetcode.com/problems/remove-duplicate-letters/) Difficulty: 🟡 Medium Topics: String, Stack, Greedy, Monotonic Stack This problem asks us to construct a new string from the input string s such that every distinct character appears exactly once…"
...
[LeetCode Problem 316](https://leetcode.com/problems/remove-duplicate-letters/)
