...
description: "--- [LeetCode Problem 392](https://leetcode.com/problems/is-subsequence/) Difficulty: 🟢 Easy Topics: Two Pointers, String, Dynamic Programming The problem asks whether string s can be formed from string t by deleting some characters from t without changing the order of the…"
