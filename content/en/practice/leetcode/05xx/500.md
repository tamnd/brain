...
description: "--- [LeetCode Problem 500](https://leetcode.com/problems/keyboard-row/) Difficulty: 🟢 Easy Topics: Array, Hash Table, String This problem asks us to determine which words in a given list can be typed using letters from only one row of an American keyboard."
