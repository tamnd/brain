...
description: "This problem asks us to compute the nth Fibonacci number. The Fibonacci sequence is defined recursively. The first two numbers are fixed: Every value after that is calculated as the sum of the previous two values: Given an integer n, we must return the value of F(n)."
