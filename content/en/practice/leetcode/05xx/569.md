...
description: "The problem gives us an Employee table containing three columns: Column Meaning --- --- id Unique employee identifier company Company name salary Employee salary We need to return the row or rows that correspond to the median salary for each company."
...
[LeetCode Problem 569](https://leetcode.com/problems/median-employee-salary/)
