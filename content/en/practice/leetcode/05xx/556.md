...
description: "This problem asks us to find the smallest integer that is strictly greater than a given integer n, while using exactly the same digits as n. In other words, we are allowed to rearrange the digits of the number, but we cannot add or remove digits."
