...
description: "The problem asks us to compute the diameter of a binary tree. The diameter is defined as the length of the longest path between any two nodes, measured in number of edges. Importantly, this path does not need to pass through the root of the tree."
