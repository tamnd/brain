...
description: "This problem asks us to perform a postorder traversal on an n-ary tree. In a binary tree, each node has at most two children. In an n-ary tree, each node can have any number of children. Every node contains a value and a list of child nodes. A postorder traversal means: 1."
...
[LeetCode Problem 590](https://leetcode.com/problems/n-ary-tree-postorder-traversal/)
