...
description: "The problem gives us an array nums that is guaranteed to be a permutation of the integers from 0 to n - 1. A permutation means every value appears exactly once, and every value is within the valid index range of the array."
