...
description: "--- [LeetCode Problem 565](https://leetcode.com/problems/array-nesting/) Difficulty: 🟡 Medium Topics: Array, Depth-First Search The problem gives us an array nums that is guaranteed to be a permutation of the integers from 0 to n - 1."
