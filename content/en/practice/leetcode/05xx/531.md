...
description: "The problem gives us a 2D grid called picture, where each cell contains either: - 'B', representing a black pixel - 'W', representing a white pixel We need to count how many lonely black pixels exist in the matrix. A black pixel is considered lonely if: 1. It is black ('B') 2."
...
[LeetCode Problem 531](https://leetcode.com/problems/lonely-pixel-i/)
