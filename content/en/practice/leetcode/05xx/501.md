...
description: "This problem asks us to find the mode(s) in a Binary Search Tree (BST). A mode is the value that appears most frequently in the tree. Since duplicates are allowed in this BST definition, a value may occur multiple times. The input is the root node of a BST."
...
[LeetCode Problem 501](https://leetcode.com/problems/find-mode-in-binary-search-tree/)
