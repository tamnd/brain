...
description: "The problem asks us to design a data structure that supports weighted random sampling. You are given an array w, where each element represents the weight of an index. Instead of choosing every index with equal probability, the selection probability depends on its weight."
...
[LeetCode Problem 528](https://leetcode.com/problems/random-pick-with-weight/)
