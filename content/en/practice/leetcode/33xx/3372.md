...
description: "This problem gives us two separate undirected trees. The first tree has n nodes labeled from 0 to n - 1, and the second tree has m nodes labeled from 0 to m - 1."
date: "2026-05-29T18:32:49+07:00"
...
$$\text{answer}[i]
=
(\text{nodes within distance } k \text{ from } i \text{ in tree1})
+
(\max \text{ nodes within distance } k-1 \text{ from any node in tree2})$$
