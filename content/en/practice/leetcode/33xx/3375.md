...
description: "We are given an array nums and a target value k. An operation works as follows: - Choose an integer h that is valid for the current array. - An integer h is valid if every array value strictly greater than h is the same number."
date: "2026-05-30T06:20:49+07:00"
...
$$\text{answer}
=
\left|\{x \in nums : x > k\}\right|_{\text{distinct}}$$
