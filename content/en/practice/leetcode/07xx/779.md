...
description: "The problem defines a special binary grammar sequence that grows row by row. The first row contains only a single value:"
...
[LeetCode Problem 779](https://leetcode.com/problems/)
