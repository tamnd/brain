...
description: "The problem gives us an integer array nums, and we want to maximize the total number of points earned by repeatedly deleting elements. When we delete a number x, we gain x points. However, deleting x also forces the removal of every occurrence of x - 1 and x + 1."
