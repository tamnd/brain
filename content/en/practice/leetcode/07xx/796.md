...
description: "--- [LeetCode Problem 796](https://leetcode.com/problems/rotate-string/) Difficulty: 🟢 Easy Topics: String, String Matching The problem asks us to determine whether one string can be transformed into another string using repeated left rotations."
