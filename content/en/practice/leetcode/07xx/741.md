...
description: "This problem asks us to collect the maximum possible number of cherries while making two trips across a square grid. The first trip starts at the top left corner (0, 0) and moves to the bottom right corner (n - 1, n - 1) using only right or down moves."
...
[LeetCode Problem 741](https://leetcode.com/problems/cherry-pickup/)
