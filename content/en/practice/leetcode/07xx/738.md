...
description: "The problem asks us to find the largest integer less than or equal to a given number n, such that its digits are monotone increasing. A number has monotone increasing digits when every digit is less than or equal to the digit that comes after it."
