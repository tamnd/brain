...
description: "--- [LeetCode Problem 767](https://leetcode.com/problems/reorganize-string/) Difficulty: 🟡 Medium Topics: Hash Table, String, Greedy, Sorting, Heap (Priority Queue), Counting The problem asks us to rearrange the characters of a given string s such that no two adjacent characters…"
