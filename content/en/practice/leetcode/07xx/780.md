...
description: "The problem asks whether it is possible to transform a starting point (sx, sy) to a target point (tx, ty) using a define"
...
[LeetCode Problem 780](https://leetcode.com/problems/)
