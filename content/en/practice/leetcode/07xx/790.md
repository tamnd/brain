...
description: "--- [LeetCode Problem 790](https://leetcode.com/problems/domino-and-tromino-tiling/) Difficulty: 🟡 Medium Topics: Dynamic Programming The problem asks us to compute the number of ways to completely tile a 2 x n board using two types of tiles: a domino (2 x 1) and a tromino shape."
