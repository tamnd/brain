...
description: "--- [LeetCode Problem 760](https://leetcode.com/problems/find-anagram-mappings/) Difficulty: 🟢 Easy Topics: Array, Hash Table The problem asks us to build an index mapping from nums1 to nums2, where nums2 is guaranteed to be an anagram of nums1."
