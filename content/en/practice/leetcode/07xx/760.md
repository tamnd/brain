...
description: "The problem asks us to build an index mapping from nums1 to nums2, where nums2 is guaranteed to be an anagram of nums1. Since an anagram means the same elements appear in both arrays, but possibly in a different order, every value in nums1 must appear somewhere in nums2."
