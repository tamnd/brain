...
description: "--- [LeetCode Problem 757](https://leetcode.com/problems/set-intersection-size-at-least-two/) Difficulty: 🔴 Hard Topics: Array, Greedy, Sorting The problem asks us to find the minimum size of a set of integers, nums, such that each given interval [starti, endi] contains at least…"
