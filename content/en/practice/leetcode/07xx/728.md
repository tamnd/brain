...
description: "--- [LeetCode Problem 728](https://leetcode.com/problems/self-dividing-numbers/) Difficulty: 🟢 Easy Topics: Math The problem asks us to find all numbers within a given inclusive range [left, right] that satisfy the definition of a self-dividing number."
