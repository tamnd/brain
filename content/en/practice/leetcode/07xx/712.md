...
description: "--- [LeetCode Problem 712](https://leetcode.com/problems/minimum-ascii-delete-sum-for-two-strings/) Difficulty: 🟡 Medium Topics: String, Dynamic Programming The problem gives us two strings, s1 and s2, and asks us to make them equal by deleting characters from either string."
