...
description: "--- [LeetCode Problem 778](https://leetcode.com/problems/swim-in-rising-water/) Difficulty: 🔴 Hard Topics: Array, Binary Search, Depth-First Search, Breadth-First Search, Union-Find, Heap (Priority Queue), Matrix In this problem, we are given an n x n grid where each cell…"
