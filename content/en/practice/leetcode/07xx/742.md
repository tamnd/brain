...
description: "--- [LeetCode Problem 742](https://leetcode.com/problems/closest-leaf-in-a-binary-tree/) Difficulty: 🟡 Medium Topics: Tree, Depth-First Search, Breadth-First Search, Binary Tree The problem asks us to find the closest leaf node to a given target node k in a binary tree."
