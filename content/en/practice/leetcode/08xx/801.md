...
description: "The problem gives us two arrays, nums1 and nums2, both of the same length. At every index i, we are allowed to either keep the values as they are, or swap nums1[i] with nums2[i]. Our goal is to make both arrays strictly increasing while performing the minimum number of swaps."
...
[LeetCode Problem 801](https://leetcode.com/problems/minimum-swaps-to-make-sequences-increasing/)
