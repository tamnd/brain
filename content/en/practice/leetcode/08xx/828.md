...
description: "The problem asks us to compute the total number of unique characters across every possible substring of a given string. A character is considered unique inside a substring if it appears exactly once within that substring."
