...
description: "--- [LeetCode Problem 857](https://leetcode.com/problems/minimum-cost-to-hire-k-workers/) Difficulty: 🔴 Hard Topics: Array, Greedy, Sorting, Heap (Priority Queue) In this problem, we are given two arrays, quality and wage, where each index represents a worker."
