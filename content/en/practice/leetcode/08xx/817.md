...
description: "--- [LeetCode Problem 817](https://leetcode.com/problems/linked-list-components/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Linked List The problem gives us a singly linked list where every node contains a unique integer value."
