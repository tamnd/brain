...
description: "--- [LeetCode Problem 800](https://leetcode.com/problems/similar-rgb-color/) Difficulty: 🟢 Easy Topics: Math, String, Enumeration The problem is asking us to find the shorthand RGB color that is most similar to a given full-length RGB color string."
