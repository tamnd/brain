...
description: "The problem asks us to find the length of the longest contiguous subarray that forms a valid mountain. A mountain is a sequence that strictly increases up to a peak, then strictly decreases afterward."
