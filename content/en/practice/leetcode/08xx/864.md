...
description: "--- [LeetCode Problem 864](https://leetcode.com/problems/shortest-path-to-get-all-keys/) Difficulty: 🔴 Hard Topics: Array, Bit Manipulation, Breadth-First Search, Matrix This problem asks us to find the shortest path to collect all keys in a 2D grid maze."
