...
description: "--- [LeetCode Problem 885](https://leetcode.com/problems/spiral-matrix-iii/) Difficulty: 🟡 Medium Topics: Array, Matrix, Simulation The problem is asking us to generate the coordinates of cells in a 2D grid that we would visit if we started at a given cell (rStart, cStart) and…"
