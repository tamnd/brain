...
description: "The problem gives us an integer array nums and an integer k. We are allowed to split the array into at most k contiguous, non-empty subarrays. For each subarray, we compute its average, then sum all of those averages together. Our goal is to maximize that total score."
...
[LeetCode Problem 813](https://leetcode.com/problems/largest-sum-of-averages/)
