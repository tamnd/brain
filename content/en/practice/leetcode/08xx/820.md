...
description: "--- [LeetCode Problem 820](https://leetcode.com/problems/short-encoding-of-words/) Difficulty: 🟡 Medium Topics: Array, Hash Table, String, Trie The problem asks us to find the length of the shortest reference string that can encode a list of words."
...
[LeetCode Problem 820](https://leetcode.com/problems/short-encoding-of-words/)
