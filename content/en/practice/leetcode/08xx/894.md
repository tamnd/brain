...
description: "--- [LeetCode Problem 894](https://leetcode.com/problems/all-possible-full-binary-trees/) Difficulty: 🟡 Medium Topics: Dynamic Programming, Tree, Recursion, Memoization, Binary Tree The problem asks us to generate every possible full binary tree that contains exactly n nodes."
