...
description: "--- [LeetCode Problem 822](https://leetcode.com/problems/card-flipping-game/) Difficulty: 🟡 Medium Topics: Array, Hash Table In this problem, we are given a collection of cards where each card has two numbers, one on the front and one on the back."
