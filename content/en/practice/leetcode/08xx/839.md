...
description: "--- [LeetCode Problem 839](https://leetcode.com/problems/similar-string-groups/) Difficulty: 🔴 Hard Topics: Array, Hash Table, String, Depth-First Search, Breadth-First Search, Union-Find The problem asks us to determine the number of similarity groups within a list of strings."
