...
description: "The problem gives us an undirected graph with n original nodes. Each edge has an associated subdivision count, meaning the edge is replaced by a chain of intermediate nodes. For an edge [u, v, cnt], the original direct connection between u and v no longer exists as a single edge."
...
[LeetCode Problem 882](https://leetcode.com/problems/reachable-nodes-in-subdivided-graph/)
