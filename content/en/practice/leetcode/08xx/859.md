...
description: "--- [LeetCode Problem 859](https://leetcode.com/problems/buddy-strings/) Difficulty: 🟢 Easy Topics: Hash Table, String The problem asks whether it is possible to make two strings equal by performing exactly one swap operation on the first string s."
