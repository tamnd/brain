...
description: "--- [LeetCode Problem 1054](https://leetcode.com/problems/distant-barcodes/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Greedy, Sorting, Heap (Priority Queue), Counting The problem is asking us to rearrange a list of barcodes so that no two adjacent barcodes are the same."
