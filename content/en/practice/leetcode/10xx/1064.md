...
description: "The problem is asking us to find a \"fixed point\" in a sorted array of distinct integers. A fixed point is an index i such that the value at that index equals the index itself, i.e., arr[i] == i."
