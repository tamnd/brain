...
description: "The problem asks us to construct the string target using the fewest possible subsequences of the string source. A subsequence preserves relative order, but characters do not need to be contiguous."
