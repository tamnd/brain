...
|---|---|---|---|---|
| 1000 | [Minimum Cost to Merge Stones](1000.md) | 🔴 Hard | 38s | The problem asks us to merge an array of stone piles into a single … |
| 1001 | [Grid Illumination](1001.md) | 🔴 Hard | 41s | You already included the problem in your previous message: LeetCode… |
| 1002 | [Find Common Characters](1002.md) | 🟢 Easy | 1m 15s | The problem gives us an array of lowercase English strings called w… |
| 1003 | [Check If Word Is Valid After Substitutions](1003.md) | 🟡 Medium | 46s | The problem asks us to determine if a given string s can be generat… |
| 1004 | [Max Consecutive Ones III](1004.md) | 🟡 Medium | 1m 1s | This problem asks us to find the maximum length of a contiguous sub… |
| 1005 | [Maximize Sum Of Array After K Negations](1005.md) | 🟢 Easy | 1m 11s | The problem gives us an integer array nums and an integer k. In one… |
