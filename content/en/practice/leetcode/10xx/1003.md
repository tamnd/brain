...
description: "--- [LeetCode Problem 1003](https://leetcode.com/problems/check-if-word-is-valid-after-substitutions/) Difficulty: 🟡 Medium Topics: String, Stack The problem asks us to determine whether a given string can be constructed by repeatedly inserting the substring \"abc\" into an…"
