...
description: "The problem gives us an integer array arr and asks whether it can be divided into exactly three non-empty contiguous parts such that all three parts have the same sum. The partitions must preserve the original order of the array. We are not allowed to rearrange elements."
