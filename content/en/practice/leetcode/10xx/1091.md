...
description: "--- [LeetCode Problem 1091](https://leetcode.com/problems/shortest-path-in-binary-matrix/) Difficulty: 🟡 Medium Topics: Array, Breadth-First Search, Matrix The problem asks us to find the shortest path from the top-left corner (0, 0) to the bottom-right corner (n-1, n-1) of a…"
