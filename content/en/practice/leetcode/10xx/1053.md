...
description: "The problem asks us to find the lexicographically largest permutation that is still smaller than the given array, using exactly one swap operation."
