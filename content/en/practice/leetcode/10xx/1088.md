...
description: "In this problem, we are given an integer n, and we must count how many numbers in the range [1, n] are considered confusing numbers. A number becomes a confusing number if, after rotating every digit by 180 degrees, the resulting number is both: 1. Valid after rotation 2."
