...
description: "--- [LeetCode Problem 1090](https://leetcode.com/problems/largest-values-from-labels/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Greedy, Sorting, Counting The problem gives us two arrays, values and labels, where each index represents a single item."
