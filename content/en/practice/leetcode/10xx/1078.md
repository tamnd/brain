...
description: "The problem gives us a string called text and two target words, first and second. We must find every occurrence where the words appear consecutively in the exact order: For every such occurrence, we return the value of third."
