...
description: "--- [LeetCode Problem 1034](https://leetcode.com/problems/coloring-a-border/) Difficulty: 🟡 Medium Topics: Array, Depth-First Search, Breadth-First Search, Matrix The problem gives us a two dimensional grid where each cell contains an integer representing a color."
