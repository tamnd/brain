...
description: "--- [LeetCode Problem 1069](https://leetcode.com/problems/product-sales-analysis-ii/) Difficulty: 🟢 Easy Topics: Database This problem asks us to calculate the total quantity sold for each product based on records in the Sales table."
