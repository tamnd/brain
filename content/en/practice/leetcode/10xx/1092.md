...
description: "--- [LeetCode Problem 1092](https://leetcode.com/problems/shortest-common-supersequence/) Difficulty: 🔴 Hard Topics: String, Dynamic Programming The problem asks us to construct the shortest possible string that contains both str1 and str2 as subsequences."
