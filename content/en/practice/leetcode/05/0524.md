...
The official problem asks us to find the longest dictionary word obtainable by deleting characters from `s`. If several answers have the same length, choose the lexicographically smallest one.
