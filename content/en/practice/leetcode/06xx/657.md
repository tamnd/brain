...
description: "--- [LeetCode Problem 657](https://leetcode.com/problems/robot-return-to-origin/) Difficulty: 🟢 Easy Topics: String, Simulation This problem asks us to determine whether a robot, starting at the origin (0, 0) on a 2D plane, returns to the origin after executing a sequence of…"
