...
description: "--- [LeetCode Problem 648](https://leetcode.com/problems/replace-words/) Difficulty: 🟡 Medium Topics: Array, Hash Table, String, Trie The problem asks us to replace words in a sentence using a set of predefined root words."
