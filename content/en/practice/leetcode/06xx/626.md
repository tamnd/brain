...
description: "This problem asks us to swap the seat IDs of every two consecutive students in a classroom. The input is a table called Seat with two columns: id, which is a unique integer representing the seat number, and student, which is a string representing the student's name."
