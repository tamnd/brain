...
description: "--- [LeetCode Problem 670](https://leetcode.com/problems/maximum-swap/) Difficulty: 🟡 Medium Topics: Math, Greedy The problem asks us to take an integer num and find the maximum number we can create by swapping at most two digits."
