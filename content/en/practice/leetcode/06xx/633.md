...
description: "--- [LeetCode Problem 633](https://leetcode.com/problems/sum-of-square-numbers/) Difficulty: 🟡 Medium Topics: Math, Two Pointers, Binary Search The problem gives a non-negative integer c and asks whether it can be represented as the sum of the squares of two integers."
