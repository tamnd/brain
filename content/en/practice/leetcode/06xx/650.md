...
description: "--- [LeetCode Problem 650](https://leetcode.com/problems/2-keys-keyboard/) Difficulty: 🟡 Medium Topics: Math, Dynamic Programming The problem is asking for the minimum number of operations required to generate exactly n characters 'A' on a notepad starting with a single 'A'."
