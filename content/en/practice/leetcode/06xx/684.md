...
description: "The problem is asking us to identify a redundant edge in a graph that started as a tree. A tree is a connected graph with n nodes and exactly n-1 edges, meaning it has no cycles. The input graph has n nodes and n edges, so by definition, it contains exactly one cycle."
...
[LeetCode Problem 684](https://leetcode.com/problems/redundant-connection/)
