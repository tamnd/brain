...
description: "The problem asks us to compute the probability that a chess knight remains on an n x n board after making exactly k moves. A knight starts at position (row, column)."
