...
description: "The problem is asking us to swap the sex values of all employees in a Salary table. Each row in the table represents an employee with four columns: id, name, sex, and salary. The sex column is an ENUM with values 'm' for male and 'f' for female."
...
[LeetCode Problem 627](https://leetcode.com/problems/swap-sex-of-employees/)
