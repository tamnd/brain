...
description: "The problem gives us a two dimensional grid representing a forest. Every cell contains one of three possible values: - 0 means the cell is blocked and cannot be entered. - 1 means the cell is empty and can be walked through."
