...
description: "The problem gives an integer array nums and asks us to select exactly three numbers whose product is as large as possible. We must return that maximum product value."
