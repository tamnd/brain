...
description: "--- [LeetCode Problem 630](https://leetcode.com/problems/course-schedule-iii/) Difficulty: 🔴 Hard Topics: Array, Greedy, Sorting, Heap (Priority Queue) The problem gives a list of online courses, where each course is represented as [duration, lastDay]."
