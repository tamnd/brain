...
description: "--- [LeetCode Problem 678](https://leetcode.com/problems/valid-parenthesis-string/) Difficulty: 🟡 Medium Topics: String, Dynamic Programming, Stack, Greedy This problem is asking whether a string containing the characters '(', ')', and '' can be considered a valid parenthesis…"
