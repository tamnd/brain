...
description: "--- [LeetCode Problem 679](https://leetcode.com/problems/24-game/) Difficulty: 🔴 Hard Topics: Array, Math, Backtracking The problem is asking us to determine whether it is possible to use exactly four numbers, each between 1 and 9 inclusive, to form a mathematical expression…"
...
[LeetCode Problem 679](https://leetcode.com/problems/24-game/)
