...
description: "--- [LeetCode Problem 658](https://leetcode.com/problems/find-k-closest-elements/) Difficulty: 🟡 Medium Topics: Array, Two Pointers, Binary Search, Sliding Window, Sorting, Heap (Priority Queue) The problem gives us a sorted integer array arr, along with two integers, k and x."
