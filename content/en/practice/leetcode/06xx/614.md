...
description: "This problem asks us to identify second-degree followers from a social network represented by a single table Follow. The table contains two columns: followee and follower. Each row indicates that a user (follower) follows another user (followee)."
...
[LeetCode Problem 614](https://leetcode.com/problems/second-degree-follower/)
