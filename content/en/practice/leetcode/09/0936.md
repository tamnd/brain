...
The official statement defines stamping onto question marks and asks for a valid sequence of moves producing `target`.
...
These are the standard examples from the official problem.
