...
description: "--- [LeetCode Problem 1164](https://leetcode.com/problems/product-price-at-a-given-date/) Difficulty: 🟡 Medium Topics: Database The problem provides a database table named Products, where each row represents a price update for a product on a specific date."
