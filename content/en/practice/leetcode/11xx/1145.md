...
description: "--- [LeetCode Problem 1145](https://leetcode.com/problems/binary-tree-coloring-game/) Difficulty: 🟡 Medium Topics: Tree, Depth-First Search, Binary Tree The problem is a two-player game played on a binary tree, where each player colors nodes starting from an initial chosen node."
