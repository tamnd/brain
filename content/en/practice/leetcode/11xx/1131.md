...
description: "--- [LeetCode Problem 1131](https://leetcode.com/problems/maximum-of-absolute-value-expression/) Difficulty: 🟡 Medium Topics: Array, Math The problem gives us two integer arrays, arr1 and arr2, both having the same length."
