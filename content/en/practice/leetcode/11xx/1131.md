...
description: "The problem gives us two integer arrays, arr1 and arr2, both having the same length. We must compute the maximum possible value of the following expression across every pair of indices (i, j): The task is not asking for the indices themselves, only the largest achievable value."
...
[LeetCode Problem 1131](https://leetcode.com/problems/maximum-of-absolute-value-expression/)
