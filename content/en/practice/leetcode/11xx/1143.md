...
description: "--- [LeetCode Problem 1143](https://leetcode.com/problems/longest-common-subsequence/) Difficulty: 🟡 Medium Topics: String, Dynamic Programming The problem asks us to find the length of the longest subsequence that appears in both input strings."
