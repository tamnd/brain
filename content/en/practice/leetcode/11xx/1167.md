...
description: "--- [LeetCode Problem 1167](https://leetcode.com/problems/minimum-cost-to-connect-sticks/) Difficulty: 🟡 Medium Topics: Array, Greedy, Heap (Priority Queue) The problem gives us an array of positive integers called sticks, where each value represents the length of a stick."
