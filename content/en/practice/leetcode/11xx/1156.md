...
description: "--- [LeetCode Problem 1156](https://leetcode.com/problems/swap-for-longest-repeated-character-substring/) Difficulty: 🟡 Medium Topics: Hash Table, String, Sliding Window The problem asks us to determine the length of the longest substring in a given string text where all…"
