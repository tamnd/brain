...
description: "--- [LeetCode Problem 1110](https://leetcode.com/problems/delete-nodes-and-return-forest/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Tree, Depth-First Search, Binary Tree This problem gives us the root of a binary tree and a list of node values that must be deleted from…"
