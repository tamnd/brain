...
description: "--- [LeetCode Problem 1155](https://leetcode.com/problems/number-of-dice-rolls-with-target-sum/) Difficulty: 🟡 Medium Topics: Dynamic Programming The problem gives us n identical dice, where each die has faces numbered from 1 to k."
