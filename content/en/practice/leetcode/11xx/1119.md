...
description: "--- [LeetCode Problem 1119](https://leetcode.com/problems/remove-vowels-from-a-string/) Difficulty: 🟢 Easy Topics: String The problem asks us to remove vowels from a given string s. Specifically, the vowels are defined as the lowercase characters 'a', 'e', 'i', 'o', and 'u'."
