...
description: "--- [LeetCode Problem 1134](https://leetcode.com/problems/armstrong-number/) Difficulty: 🟢 Easy Topics: Math In this problem, we are given an integer n, and we must determine whether it is an Armstrong number."
