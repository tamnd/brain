...
description: "--- [LeetCode Problem 1182](https://leetcode.com/problems/shortest-distance-to-target-color/) Difficulty: 🟡 Medium Topics: Array, Binary Search, Dynamic Programming The problem gives us an array called colors, where each position contains one of three possible values: 1, 2, or 3."
