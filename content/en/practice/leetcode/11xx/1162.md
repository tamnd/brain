...
description: "--- [LeetCode Problem 1162](https://leetcode.com/problems/as-far-from-land-as-possible/) Difficulty: 🟡 Medium Topics: Array, Dynamic Programming, Breadth-First Search, Matrix The problem requires finding the water cell in a given n x n grid that is farthest from any land cell…"
