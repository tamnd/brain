...
description: "--- [LeetCode Problem 1161](https://leetcode.com/problems/) Difficulty: 🟡 Medium Topics: Tree, Depth-First Search, Breadth-First Search, Binary Tree In this problem, we are given the root node of a binary tree. Every node belongs to a specific level in the tree."
