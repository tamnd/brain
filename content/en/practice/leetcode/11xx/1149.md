...
description: "--- [LeetCode Problem 1149](https://leetcode.com/problems/article-views-ii/) Difficulty: 🟡 Medium Topics: Database The problem gives us a database table named Views. Each row represents a single viewing event where a user viewed an article on a specific date."
