...
The official problem defines a height-balanced binary tree as a binary tree where the depth difference between the two subtrees of every node never exceeds `1`.
