...
description: "--- [LeetCode Problem 494](https://leetcode.com/problems/target-sum/) Difficulty: 🟡 Medium Topics: Array, Dynamic Programming, Backtracking The problem asks us to count how many different ways we can assign either a '+' or '-' sign to every number in the array nums such that the…"
