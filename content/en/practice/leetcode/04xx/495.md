...
description: "The problem asks us to calculate the total duration that Ashe is poisoned by Teemo's attacks. Each attack at a given second t causes Ashe to be poisoned for exactly duration seconds, and the poisoning time is inclusive, meaning that the poison effect lasts from time t to t +…"
...
[LeetCode Problem 495](https://leetcode.com/problems/teemo-attacking/)
