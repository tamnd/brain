...
description: "The problem is asking us to find the smallest integer k = 2 such that a given number n can be represented in base k with all digits equal to 1. In other words, we want n to be a sum of consecutive powers of k, like 1 + k + k^2 + ... + k^(m-1) for some integer m = 2."
