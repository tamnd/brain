...
description: "--- [LeetCode Problem 448](https://leetcode.com/problems/find-all-numbers-disappeared-in-an-array/) Difficulty: 🟢 Easy Topics: Array, Hash Table The problem asks us to find all the integers in the range [1, n] that are missing from an input array nums of length n."
