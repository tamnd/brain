...
description: "The problem gives us a string representing a nested ternary expression and asks us to evaluate it. A ternary expression follows the familiar format: The condition is always either 'T' or 'F'. If the condition is 'T', the expression evaluates to the value before the ':'."
...
[LeetCode Problem 439](https://leetcode.com/problems/ternary-expression-parser/)
