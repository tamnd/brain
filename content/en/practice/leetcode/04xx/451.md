...
description: "--- [LeetCode Problem 451](https://leetcode.com/problems/sort-characters-by-frequency/) Difficulty: 🟡 Medium Topics: Hash Table, String, Sorting, Heap (Priority Queue), Bucket Sort, Counting The problem asks us to rearrange the characters of a string so that characters with…"
