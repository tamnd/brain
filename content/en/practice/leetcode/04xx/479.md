...
description: "--- [LeetCode Problem 479](https://leetcode.com/problems/largest-palindrome-product/) Difficulty: 🔴 Hard Topics: Math, Enumeration The problem asks us to find the largest palindrome number that can be written as the product of two n-digit integers."
