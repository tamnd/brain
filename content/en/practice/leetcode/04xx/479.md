...
description: "The problem asks us to find the largest palindrome number that can be written as the product of two n-digit integers. A palindrome is a number that reads the same forward and backward. For example, 9009 is a palindrome because reversing its digits still gives 9009."
...
[LeetCode Problem 479](https://leetcode.com/problems/largest-palindrome-product/)
