...
description: "The problem gives us a binary array nums, where every element is either 0 or 1. We want to find the longest contiguous subarray containing only 1s after we are allowed to flip at most one 0 into a 1."
