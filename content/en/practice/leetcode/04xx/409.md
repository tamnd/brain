...
description: "--- [LeetCode Problem 409](https://leetcode.com/problems/longest-palindrome/) Difficulty: 🟢 Easy Topics: Hash Table, String, Greedy The problem asks us to find the length of the longest palindrome that can be constructed using the characters of a given string s."
