...
description: "The problem gives us an integer array nums and asks us to return every distinct subsequence that is non-decreasing and has length at least two. A subsequence is formed by deleting zero or more elements from the array without changing the relative order of the remaining elements."
...
[LeetCode Problem 491](https://leetcode.com/problems/non-decreasing-subsequences/)
