...
description: "This problem defines a special infinite sequence called the magical string. The string contains only the characters '1' and '2', and its defining property is very unusual: If you group consecutive identical digits together and record the length of each group, the resulting…"
...
[LeetCode Problem 481](https://leetcode.com/problems/magical-string/)
