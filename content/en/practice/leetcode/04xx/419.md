...
description: "--- [LeetCode Problem 419](https://leetcode.com/problems/battleships-in-a-board/) Difficulty: 🟡 Medium Topics: Array, Depth-First Search, Matrix This problem gives us a two dimensional grid where each cell contains either 'X' or '.'."
