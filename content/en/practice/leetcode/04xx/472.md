...
description: "--- [LeetCode Problem 472](https://leetcode.com/problems/concatenated-words/) Difficulty: 🔴 Hard Topics: Array, String, Dynamic Programming, Depth-First Search, Trie, Sorting The problem asks us to identify all words in a given list that can be formed by concatenating at least…"
