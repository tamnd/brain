...
description: "--- [LeetCode Problem 442](https://leetcode.com/problems/find-all-duplicates-in-an-array/) Difficulty: 🟡 Medium Topics: Array, Hash Table, Sorting The problem gives us an integer array nums of length n, where every value is guaranteed to be in the range [1, n]."
