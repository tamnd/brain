...
description: "The problem gives us an integer array nums of length n, where every value is guaranteed to be in the range [1, n]. Each number appears either once or twice. Our task is to return all numbers that appear exactly twice."
