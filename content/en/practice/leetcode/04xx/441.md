...
description: "--- [LeetCode Problem 441](https://leetcode.com/problems/arranging-coins/) Difficulty: 🟢 Easy Topics: Math, Binary Search The problem asks us to determine how many complete rows of a coin staircase can be formed using exactly n coins."
