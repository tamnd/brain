...
description: "The problem gives us two non-empty singly linked lists where each node stores a single digit of a non-negative integer. Unlike the classic \"Add Two Numbers\" problem, the digits are stored in forward order, meaning the most significant digit appears first."
...
[LeetCode Problem 445](https://leetcode.com/problems/add-two-numbers-ii/)
