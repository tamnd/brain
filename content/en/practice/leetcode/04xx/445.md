...
description: "--- [LeetCode Problem 445](https://leetcode.com/problems/add-two-numbers-ii/) Difficulty: 🟡 Medium Topics: Linked List, Math, Stack The problem gives us two non-empty singly linked lists where each node stores a single digit of a non-negative integer."
