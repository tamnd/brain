...
description: "The problem asks us to determine whether a given string can be formed by repeating one of its substrings multiple times. In other words, we want to know if there exists some substring pattern such that concatenating that pattern repeatedly recreates the entire string exactly."
...
[LeetCode Problem 459](https://leetcode.com/problems/repeated-substring-pattern/)
