...
description: "--- [LeetCode Problem 459](https://leetcode.com/problems/repeated-substring-pattern/) Difficulty: 🟢 Easy Topics: String, String Matching The problem asks us to determine whether a given string can be formed by repeating one of its substrings multiple times."
