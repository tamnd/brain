...
description: "--- [LeetCode Problem 988](https://leetcode.com/problems/smallest-string-starting-from-leaf/) Difficulty: 🟡 Medium Topics: String, Backtracking, Tree, Depth-First Search, Binary Tree The problem gives us the root of a binary tree where every node stores an integer between 0 and…"
