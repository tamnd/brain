...
description: "--- [LeetCode Problem 970](https://leetcode.com/problems/powerful-integers/) Difficulty: 🟡 Medium Topics: Hash Table, Math, Enumeration This problem asks us to generate all integers that can be written in the form: where: - i = 0 - j = 0 - the resulting value is less than or…"
