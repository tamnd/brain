...
description: "--- [LeetCode Problem 944](https://leetcode.com/problems/delete-columns-to-make-sorted/) Difficulty: 🟢 Easy Topics: Array, String The problem gives us an array of strings where every string has exactly the same length."
