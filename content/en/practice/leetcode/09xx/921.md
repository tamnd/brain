...
description: "--- [LeetCode Problem 921](https://leetcode.com/problems/minimum-add-to-make-parentheses-valid/) Difficulty: 🟡 Medium Topics: String, Stack, Greedy The problem asks us to determine the minimum number of parentheses insertions required to make a given string of parentheses valid."
