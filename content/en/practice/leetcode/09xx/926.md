...
description: "--- [LeetCode Problem 926](https://leetcode.com/problems/flip-string-to-monotone-increasing/) Difficulty: 🟡 Medium Topics: String, Dynamic Programming The problem asks us to transform a binary string into a monotone increasing string using the minimum number of character flips."
