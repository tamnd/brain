...
description: "--- [LeetCode Problem 973](https://leetcode.com/problems/k-closest-points-to-origin/) Difficulty: 🟡 Medium Topics: Array, Math, Divide and Conquer, Geometry, Sorting, Heap (Priority Queue), Quickselect This problem asks us to find the k points that are closest to the origin…"
...
[LeetCode Problem 973](https://leetcode.com/problems/k-closest-points-to-origin/)
