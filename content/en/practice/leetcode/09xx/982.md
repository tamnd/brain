...
description: "--- [LeetCode Problem 982](https://leetcode.com/problems/triples-with-bitwise-and-equal-to-zero/) Difficulty: 🔴 Hard Topics: Array, Hash Table, Bit Manipulation This problem asks us to count the number of triples (i, j, k) from an integer array nums such that the bitwise AND of…"
...
[LeetCode Problem 982](https://leetcode.com/problems/triples-with-bitwise-and-equal-to-zero/)
