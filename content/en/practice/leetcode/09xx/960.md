...
description: "--- [LeetCode Problem 960](https://leetcode.com/problems/delete-columns-to-make-sorted-iii/) Difficulty: 🔴 Hard Topics: Array, String, Dynamic Programming This problem asks us to find the minimum number of columns to delete from a set of equal-length strings so that each…"
