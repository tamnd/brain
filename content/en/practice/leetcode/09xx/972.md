...
description: "--- [LeetCode Problem 972](https://leetcode.com/problems/equal-rational-numbers/) Difficulty: 🔴 Hard Topics: Math, String The problem asks us to determine whether two strings s and t, each representing a rational number in decimal notation, correspond to the same numerical value."
