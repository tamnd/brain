...
description: "In this problem, we are given two strings, name and typed. The string name represents the intended sequence of characters your friend wanted to type. The string typed represents the actual characters that appeared on the screen."
