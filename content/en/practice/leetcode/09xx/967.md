...
description: "--- [LeetCode Problem 967](https://leetcode.com/problems/numbers-with-same-consecutive-differences/) Difficulty: 🟡 Medium Topics: Backtracking, Breadth-First Search The problem asks us to generate all integers of length n such that the absolute difference between every two…"
