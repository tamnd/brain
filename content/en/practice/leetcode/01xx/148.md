...
description: "--- [LeetCode Problem 148](https://leetcode.com/problems/sort-list/) Difficulty: 🟡 Medium Topics: Linked List, Two Pointers, Divide and Conquer, Sorting, Merge Sort The problem asks us to sort a singly linked list in ascending order and return the head of the sorted list."
