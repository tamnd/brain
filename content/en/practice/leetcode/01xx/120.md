...
description: "--- [LeetCode Problem 120](https://leetcode.com/problems/triangle/) Difficulty: 🟡 Medium Topics: Array, Dynamic Programming The problem gives us a triangular array of integers and asks us to compute the minimum path sum from the top row to the bottom row."
