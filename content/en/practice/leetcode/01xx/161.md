...
description: "--- [LeetCode Problem 161](https://leetcode.com/problems/one-edit-distance/) Difficulty: 🟡 Medium Topics: Two Pointers, String The problem asks us to determine whether two strings are exactly one edit apart. An edit can be one of three operations: 1. Insert a single character 2."
