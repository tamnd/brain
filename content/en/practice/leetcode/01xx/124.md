...
description: "--- [LeetCode Problem 124](https://leetcode.com/problems/binary-tree-maximum-path-sum/) Difficulty: 🔴 Hard Topics: Dynamic Programming, Tree, Depth-First Search, Binary Tree The problem is asking us to find the maximum path sum in a binary tree."
