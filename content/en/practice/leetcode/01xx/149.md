...
description: "--- [LeetCode Problem 149](https://leetcode.com/problems/max-points-on-a-line/) Difficulty: 🔴 Hard Topics: Array, Hash Table, Math, Geometry The problem gives us a list of points on a 2D coordinate plane. Each point is represented as [x, y], where x and y are integer coordinates."
