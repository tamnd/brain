...
description: "The problem asks us to design a custom stack data structure that behaves like a normal stack, while also supporting an additional operation called getMin(). This operation must return the minimum value currently stored in the stack, and it must do so in constant time, O(1)."
