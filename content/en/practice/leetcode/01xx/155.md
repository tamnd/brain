...
description: "--- [LeetCode Problem 155](https://leetcode.com/problems/min-stack/) Difficulty: 🟡 Medium Topics: Stack, Design The problem asks us to design a custom stack data structure that behaves like a normal stack, while also supporting an additional operation called getMin()."
