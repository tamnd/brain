...
$$\text{working\_percentage} = \frac{\text{number of distinct working drivers in that month}} {\text{number of available drivers by end of that month}} \times 100$$
...
$$\text{working\_percentage} = \frac{\text{working drivers}} {\text{active drivers}} \times 100$$
