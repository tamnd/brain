...
description: "The problem gives us a list of intervals that are already sorted by starting value and guaranteed to be non-overlapping. Each interval represents a continuous range, written as [start, end]."
