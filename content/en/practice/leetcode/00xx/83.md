...
description: "--- [LeetCode Problem 83](https://leetcode.com/problems/remove-duplicates-from-sorted-list/) Difficulty: 🟢 Easy Topics: Linked List This problem asks us to remove duplicate values from a sorted singly linked list so that every distinct value appears exactly once."
