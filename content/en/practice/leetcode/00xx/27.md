...
description: "The problem gives us an integer array nums and a target value val. Our task is to remove every occurrence of val from the array, but we must do it in-place. This means we are not supposed to create another array and return it. Instead, we modify the original array directly."
