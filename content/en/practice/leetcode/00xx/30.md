...
description: "The problem asks us to find all starting indices in a string s where a substring exists that is a concatenation of all the words in the array words exactly once, without any intervening characters. The words can appear in any order, and all words in words have the same length."
