...
description: "--- [LeetCode Problem 17](https://leetcode.com/problems/letter-combinations-of-a-phone-number/) Difficulty: 🟡 Medium Topics: Hash Table, String, Backtracking The problem gives a string of digits where each digit is between 2 and 9."
