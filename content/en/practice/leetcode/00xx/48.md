...
description: "--- [LeetCode Problem 48](https://leetcode.com/problems/rotate-image/) Difficulty: 🟡 Medium Topics: Array, Math, Matrix The problem gives us an n x n square matrix that represents an image. Each element in the matrix corresponds to a pixel or value in the image."
