...
description: "The problem gives us a two dimensional grid of size m x n, where each cell contains a non-negative integer. We begin at the top-left corner of the grid, specifically at position (0, 0), and want to reach the bottom-right corner at position (m - 1, n - 1)."
...
[LeetCode Problem 64](https://leetcode.com/problems/minimum-path-sum/)
