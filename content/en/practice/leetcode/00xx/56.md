...
description: "--- [LeetCode Problem 56](https://leetcode.com/problems/merge-intervals/) Difficulty: 🟡 Medium Topics: Array, Sorting The problem gives an array of intervals, where each interval is represented as [start, end]."
