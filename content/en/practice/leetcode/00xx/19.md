...
description: "--- [LeetCode Problem 19](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) Difficulty: 🟡 Medium Topics: Linked List, Two Pointers This problem asks us to remove the nth node counted from the end of a singly linked list and return the modified list."
