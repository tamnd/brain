...
description: "This problem asks us to determine whether an entire input string s matches a wildcard pattern p. The pattern supports two special wildcard characters: - '?' matches exactly one character. - '' matches any sequence of characters, including an empty sequence."
