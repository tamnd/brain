...
description: "This problem asks us to find all unique combinations of numbers from the candidates array such that the sum of the chosen numbers equals target. Unlike the original Combination Sum problem, each number can only be used once."
