...
description: "--- [LeetCode Problem 45](https://leetcode.com/problems/jump-game-ii/) Difficulty: 🟡 Medium Topics: Array, Dynamic Programming, Greedy The problem gives an array nums where each value represents the maximum distance you can jump forward from that position."
