...
description: "--- [LeetCode Problem 3](https://leetcode.com/problems/longest-substring-without-repeating-characters/) Difficulty: 🟡 Medium Topics: Hash Table, String, Sliding Window The problem gives a string s and asks for the length of the longest substring that contains no repeated…"
