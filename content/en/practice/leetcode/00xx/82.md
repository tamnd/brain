...
description: "--- [LeetCode Problem 82](https://leetcode.com/problems/remove-duplicates-from-sorted-list-ii/) Difficulty: 🟡 Medium Topics: Linked List, Two Pointers This problem asks us to process a sorted singly linked list and remove every value that appears more than once."
