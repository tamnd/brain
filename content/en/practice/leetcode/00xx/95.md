...
description: "--- [LeetCode Problem 95](https://leetcode.com/problems/unique-binary-search-trees-ii/) Difficulty: 🟡 Medium Topics: Dynamic Programming, Backtracking, Tree, Binary Search Tree, Binary Tree The problem asks us to generate all structurally unique binary search trees (BSTs) that…"
