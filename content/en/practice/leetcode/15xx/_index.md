---
title: "LeetCode 15xx"
description: "LeetCode problems 1500–1599"
...
|---|---|---|---|---|
| 1500 | [Design a File Sharing System](1500.md) | 🟡 Medium | 1m 26s | This problem asks us to design a miniature peer-to-peer file sharin… |
| 1501 | [Countries You Can Safely Invest In](1501.md) | 🟡 Medium | 1m 2s | This is a SQL database problem where we need to identify countries … |
| 1502 | [Can Make Arithmetic Progression From Sequence](1502.md) | 🟢 Easy | 52s | The problem asks us to determine whether the elements of a given ar… |
| 1503 | [Last Moment Before All Ants Fall Out of a Plank](1503.md) | 🟡 Medium | 55s | The problem describes a plank of length n on which ants are walking… |
| 1504 | [Count Submatrices With All Ones](1504.md) | 🟡 Medium | 1m 34s | The problem gives us an m x n binary matrix where each cell contain… |
...
| 1515 | [Best Position for a Service Centre](1515.md) | 🔴 Hard | 52s | The problem asks us to find the optimal location for a service cent… |
| 1516 | [Move Sub-Tree of N-Ary Tree](1516.md) | 🔴 Hard | 1m 45s | This problem asks us to modify the structure of an N-ary tree by mo… |
...
| 1530 | [Number of Good Leaf Nodes Pairs](1530.md) | 🟡 Medium | 1m 29s | This problem gives us the root of a binary tree and an integer dist… |
| 1531 | [String Compression II](1531.md) | 🔴 Hard | 1m 30s | The problem asks us to minimize the length of a run-length encoded … |
| 1532 | [The Most Recent Three Orders](1532.md) | 🟡 Medium | 1m 8s | This problem asks us to retrieve the three most recent orders for e… |
| 1533 | [Find the Index of the Large Integer](1533.md) | 🟡 Medium | 53s | The problem presents an array arr where all elements are equal exce… |
| 1534 | [Count Good Triplets](1534.md) | 🟢 Easy | 1m 25s | The problem asks us to count the number of good triplets in an inte… |
| 1535 | [Find the Winner of an Array Game](1535.md) | 🟡 Medium | 1m 11s | The problem describes a competitive game played on an array of dist… |
