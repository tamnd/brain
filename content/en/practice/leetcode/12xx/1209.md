...
description: "--- [LeetCode Problem 1209](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string-ii/) Difficulty: 🟡 Medium Topics: String, Stack The problem asks us to repeatedly remove groups of exactly k adjacent identical characters from a string until no more such groups…"
