...
description: "--- [LeetCode Problem 1228](https://leetcode.com/problems/missing-number-in-arithmetic-progression/) Difficulty: 🟢 Easy Topics: Array, Math The problem asks us to find a missing value from an array that originally formed an arithmetic progression (AP)."
