...
description: "--- [LeetCode Problem 1233](https://leetcode.com/problems/remove-sub-folders-from-the-filesystem/) Difficulty: 🟡 Medium Topics: Array, String, Depth-First Search, Trie This problem asks us to process a list of folder paths and remove all sub-folders, returning only the top-level…"
