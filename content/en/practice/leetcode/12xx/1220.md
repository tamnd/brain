...
description: "The problem asks us to count how many valid strings of length n can be formed using only the five lowercase vowels: - 'a' - 'e' - 'i' - 'o' - 'u' However, the strings are not arbitrary. Each vowel has strict rules about which vowels may appear immediately after it."
