...
description: "--- [LeetCode Problem 1220](https://leetcode.com/problems/count-vowels-permutation/) Difficulty: 🔴 Hard Topics: Dynamic Programming The problem asks us to count how many valid strings of length n can be formed using only the five lowercase vowels: - 'a' - 'e' - 'i' - 'o' - 'u'…"
