...
description: "--- [LeetCode Problem 1215](https://leetcode.com/problems/stepping-numbers/) Difficulty: 🟡 Medium Topics: Math, Backtracking, Breadth-First Search The problem is asking us to find all integers within a given range [low, high] that are stepping numbers."
