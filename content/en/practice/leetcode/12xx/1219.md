...
description: "The problem gives us a two dimensional grid representing a gold mine. Each cell contains either a positive amount of gold or 0, which means the cell is empty. We are allowed to start from any cell that contains gold and move through the grid collecting gold along the way."
