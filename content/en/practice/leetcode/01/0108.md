...
The official problem defines a height-balanced binary tree as a binary tree in which the depth difference between the two subtrees of every node is never more than `1`.
