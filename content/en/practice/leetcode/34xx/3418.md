...
description: "We are given an m x n grid coins, where each cell contributes either a gain or a loss to the robot's total money. The robot starts at position (0, 0) and must reach (m - 1, n - 1). At every step it may move only: - one cell to the right, or - one cell downward."
date: "2026-05-30T08:08:32+07:00"
