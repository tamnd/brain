...
description: "We are given two integers l and r, and we must count how many integers in the inclusive range [l, r] are beautiful. A number is considered beautiful when: - Compute the sum of its digits. - Compute the product of its digits. - The product must be divisible by the sum."
date: "2026-05-30T10:42:12+07:00"
...
$$\text{numbers with zero digit}
=
\text{all positive numbers}
-
\text{numbers with no zero digit}$$
