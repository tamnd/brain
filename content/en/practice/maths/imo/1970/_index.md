...
|---|---------|--------|------|-------|
| 1 | Problem 1 | - | - | Let $M$ be a point on the side $AB$ of $\triangle ABC$. Let $r_1, r_2$, and $r$ be the inscribed ci… |
| 2 | Problem 2 | - | - | Let $a, b$, and $n$ be integers greater than 1, and let $a$ and $b$ be the bases of two number syst… |
