...
$$h^2=p(a-p)=2\cdot8=16,
\qquad h=4.$$

The claimed formula gives

$$\tan\alpha=\frac{4\cdot3\cdot4}{(9-1)\cdot10}
=\frac{48}{80}
=\frac35.$$
...
$$h\left(
\frac1{x_1-p}-\frac1{x_2-p}
\right)
=
h\cdot
\frac{x_2-x_1}{(x_1-p)(x_2-p)}.$$
...
$$(x_1-p)(x_2-p)
=
x_1x_2-p(x_1+x_2)+p^2
=
\frac{a^2(n^2-1)}{4n^2}-ap+p^2.$$
...
$$\tan\alpha
=
\frac{\lVert u\times v\rVert}{u\cdot v}.$$
