...
$$d_{AB}^2
=
\frac{\|(P-A)\times(B-A)\|^2}{\|B-A\|^2}.$$

Substituting $P=(0,0,0)$ gives

$$d_{AB}^2
=
\frac{(0,3,-2)\times(0,-4,-6)}{52}
=
\frac{52}{52}
=
1.$$
...
$$d_{AB}^2
=
\frac{(zv-yw)^2+z^2(u-x)^2+y^2(u-x)^2}{y^2+z^2}.$$

Expanding and simplifying yields

$$d_{AB}^2
=
u^2+\frac{(zv-yw)^2}{y^2+z^2}-2xu+x^2.$$
...
$$\frac{\|(0,0,-2)\times(0,-2,-2)\|^2}{8}
=
1.$$

For the edge $AC$,

$$\frac{\|(2,0,0)\times(-2,0,-2)\|^2}{8}
=
1.$$
