...
For convenience, we shall write $f^2, fg, \cdots$ for the functions $f \circ f, f \circ g, \cdots$.
...
The given condition means that $f^3(x) = g^2f(x)$ and $gfg(x) = fg^2(x)$. Since $x \in S \cup T = U$, we have two cases:

$x \in S$. Then $f^2(x) = g^2(x)$, which also implies $f^3(x) = fg^2(x)$. Therefore $gfg(x) = fg^2(x) = f^3(x) = g^2f(x)$, and since $g$ is a bijection, we obtain $fg(x) = gf(x)$, i.e., $x \in T$.

$x \in T$. Then $fg(x) = gf(x)$, so $g^2f(x) = gfg(x)$. It follows that $f^3(x) = g^2f(x) = gfg(x) = fg^2(x)$, and since $f$ is a bijection, we obtain $x \in S$.
