...
$$a \cos \alpha + b \sin \alpha \leq c,$$

$$a \sin \alpha + b \cos \alpha \leq d.$$

$(1)$

Hence $ABCD$ can be placed within $EFGH$ if and only if there is an

$\alpha \in [0, \pi/2]$ for which $(1)$ holds.

The lines $l_1(ax + by = c)$ and $l_2(bx + ay = d)$ and the axes $x$ and $y$ bound

a region $R$. By $(1)$, the desired placement of the rectangles is possible if
...
Second remark. This problem is essentially very similar to $(\mathrm{SL}89\text{-}2)$.
