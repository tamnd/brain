...
$$\frac{a^2}{b} + \frac{b^2}{a} = \frac{a^2 + b^2}{ab} + ab$$
...
$$b^3 + 2bc + \left[\frac{c^2}{b}\right] = \frac{b^4 + 2b^2 c + b^2 + c^2}{b^3 + bc} + b^3 + bc,$$

which reduces to

$$(c - 1)b + \frac{c^2}{b} = \frac{b^2(c + 1) + c^2}{b^3 + bc}.
\tag{1}$$
...
$$\frac{b^2(c + 1) + c^2}{b^3 + bc} \geq (c - 1)b.$$
