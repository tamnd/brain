...
description: "A _ternary tree_ is defined recursively as either empty, or consisting of a root together with three ordered ternary subtrees, called the first, second, and third subtrees."
...
A _ternary tree_ is defined recursively as either empty, or consisting of a root together with three ordered ternary subtrees, called the first, second, and third subtrees. More generally, for any fixed integer $t\ge2$, a _$t$-ary tree_ is either empty, or consists of a root together with $t$ ordered $t$-ary subtrees.
