...
description: "Exercise `12` specifies `DIFF[8]` for exponentiation, corresponding to rule `(19)`: = D(u) \\times \\bigl(v \\times (u \\uparrow (v - 1))\\bigr) + \\bigl((\\ln u) \\times D(v)\\bigr)\\times(u \\uparrow v)."
date: "2026-05-30T15:26:36+07:00"
