...
description: "The exercise asks for a program that performs algebraic simplification on the tree representation of formulas described in Section 2."
date: "2026-05-30T19:49:07+07:00"
...
1. Associate with each term a coefficient and with each factor an exponent.
2. Replace operators `-`, `/`, `\uparrow`, and `neg` whenever equivalent additive or multiplicative forms exist.
3. Treat `+` and `\times` as $n$-ary operators.
4. Collect like terms after sorting operands into a canonical order.
