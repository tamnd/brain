...
description: "A partially ordered set $(P, \\preceq)$ corresponds to an unordered tree if and only if $P$ has a least element $r$ (the root) and, for every $x \\in P \\setminus {r}$, the set of elements less than $x$..."
