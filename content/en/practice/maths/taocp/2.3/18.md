...
description: "In List (3), the notation `L[i_1, i_2, \\dots]` refers to the node reached by starting at the root of `L`, following the $i_1$-th child, then the $i_2$-th child of that node, and so on."
