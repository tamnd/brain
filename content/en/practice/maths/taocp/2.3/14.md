...
description: "Let the elements of $S$ be regarded as nodes, and define the parent of a node $\\alpha.m$ to be $\\alpha$ when $m=1$, and define the nodes $\\alpha.1,\\alpha.2,\\ldots$ to be the children of $\\alpha$ whene..."
