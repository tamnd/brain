...
date: "2026-05-29T19:26:11+07:00"
...
(x_j+y_i)
\left(\prod_{\substack{1\le k\le n\\k\ne j}}(x_j-x_k)\right)
\left(\prod_{\substack{1\le k\le n\\k\ne i}}(y_i-y_k)\right)
}.$$
...
=
\sum_{k=1}^n \frac1{x_i+y_k}\,b_{kj}.$$
...
\cdot
\frac{
\prod_{1\le r\le n}(x_j+y_r)(x_r+y_k)
}{
(x_j+y_k)
\left(\prod_{\substack{1\le r\le n\\r\ne j}}(x_j-x_r)\right)
\left(\prod_{\substack{1\le r\le n\\r\ne k}}(y_k-y_r)\right)
}.$$
...
$$=
\frac{
\prod_{1\le r\le n}(x_j+y_r)
}{
\prod_{\substack{1\le r\le n\\r\ne j}}(x_j-x_r)
}
\sum_{k=1}^n
\frac{
\prod_{1\le r\le n}(x_r+y_k)
}{
(x_i+y_k)(x_j+y_k)
\prod_{\substack{1\le r\le n\\r\ne k}}(y_k-y_r)
}.
...
$$\frac1{(x_i+y_k)(x_j+y_k)}
=
\frac1{x_j-x_i}
\left(
\frac1{x_i+y_k}-\frac1{x_j+y_k}
\right),$$
