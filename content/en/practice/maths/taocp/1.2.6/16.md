...
$$(-1)^n \binom{-n}{k-1} = (-1)^n \cdot (-1)^{k-1} \frac{n(n+1)\cdots(n+k-2)}{(k-1)!} 
= (-1)^{n+k-1} \frac{n(n+1)\cdots(n+k-2)}{(k-1)!}. \tag{1}$$
...
$$(-1)^k \binom{-k}{n-1} = (-1)^k \cdot (-1)^{n-1} \frac{k(k+1)\cdots(k+n-2)}{(n-1)!} 
= (-1)^{n+k-1} \frac{k(k+1)\cdots(k+n-2)}{(n-1)!}. \tag{2}$$
