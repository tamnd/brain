...
description: "We begin with the left-hand side of the identity and apply the definition (3) of binomial coefficients for general integers $r$: \\binom{-n}{k-1} = \\frac{(-n)(-n-1)\\cdots(-n-(k-2))}{(k-1)!"
