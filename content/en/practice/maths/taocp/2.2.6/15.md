...
description: "A direct transcription of Algorithm $S$ into MIXAL is possible if the fields `ROW`, `COL`, `VAL`, `LEFT`, and `UP` are assigned fixed offsets within each node, and if the floating-point instructions `..."
