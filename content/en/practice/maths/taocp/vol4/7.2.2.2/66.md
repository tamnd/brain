...
**Exercise 66.** [*24*] $[24]$ Use a SAT solver to find short counterparts to Fig. 35 in which (a) $N_1 = \mathbf{LIFE}$; (b) $X_2 = \mathbf{LIFE}$. In each case $X_0$ should have the smallest possible number of live cells.
