...
**Exercise 56.** &#9654; [*22*] $[22]$ Equation (27) exhibits a function matching Table 2 that depends on only 8 of the 20 variables. Use a SAT solver to show that we can actually find a suitable $f$ that depends on only *five* of the $x_j$.
