...
**Exercise 94.** &#9654; [*21*] Suppose we know that $(X_0 \to X_1 \to \cdots \to X_r) \land \neg\Phi(X_r)$ is unsatisfiable for $0 \le r \le k$. What clauses will guarantee that $\Phi$ is invariant? (The case $k = 1$ is (51).)
