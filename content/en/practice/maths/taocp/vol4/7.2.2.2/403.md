...
**Exercise 403.** [*20*] *[20]* Suppose $x$, $y$, $z$ have the order encoding, with $0 \le x, y, z < d$. What clauses enforce (a) $\min(x, y) \le z$? (b) $\max(x, y) \le z$? (c) $\min(x, y) \ge z$? (d) $\max(x, y) \ge z$?
