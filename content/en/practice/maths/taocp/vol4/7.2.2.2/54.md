...
**Exercise 54.** &#9654; [*29*] $[29]$ Extend Table 2 using the rule in the previous exercise. How many rows are needed before $f(x)$ has no $M$-term representation in DNF, when $M = 3$, 4, and 5?
