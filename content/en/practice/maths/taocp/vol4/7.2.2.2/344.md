---
title: "TAOCP 7.2.2.2 Exercise 344"
...
date: "2026-07-17T03:04:05+07:00"
...
**Exercise 344.** [*M33*] Given a graph $G$ as in Theorem S, let $B_1, \ldots, B_m$ have the joint probability distribution of exercise MPR–31, with $\pi_I = 0$ whenever $I$ contains distinct vertices $\{i, j\}$ with $i \mathbin{\text{---}} j$, otherwise $\pi_I = \prod_{i \in I} p_i$.

a) Show that this distribution is legal (see exercise MPR–32) if $(p_1, \ldots, p_m) \in \mathcal{R}(G)$.
b) Show that this "extreme distribution" also satisfies condition $(147)$.
c) Let $\beta(G) = \Pr(\overline{B}_1 \cap \cdots \cap \overline{B}_m)$. If $J \subseteq \{1, \ldots, m\}$, express $\beta(G | J)$ in terms of $M_G$.
d) Defining $\alpha(G)$ as in exercise 317, with events $A_j$ satisfying $(133)$ and probabilities $(p_1, \ldots, p_m) \in \mathcal{R}(G)$, show that $\alpha(G | J) \ge \beta(G | J)$ for all $J \subseteq \{1, \ldots, m\}$.
e) If $p_i$ satisfies $(134)$, show that $\beta(G | J) \ge \prod_{j \in J}(1 - \theta_j)$.
