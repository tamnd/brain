...
**Exercise 84.** [*33*] Prove that $f^*(i,j) = f(i,j)$ in the following cases when $j > 0$: (a) $i = j$, $i = j + 1$, (b) (i) $i = 0$ and $i = -1$. (c) $i = 1 - j$. (d) $i = -2$.
