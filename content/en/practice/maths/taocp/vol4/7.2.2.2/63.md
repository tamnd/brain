...
**Exercise 63.** &#9654; [*29*] $[29]$ Given an $n$-network $\alpha = [i_1 : j_1][i_2 : j_2] \cdots [i_r : j_r]$, as defined in the exercises for Section 5.3.4, explain how to use a SAT solver to test whether or not $\alpha$ is a sorting network. *Hint:* Use Theorem 5.3.4Z.
