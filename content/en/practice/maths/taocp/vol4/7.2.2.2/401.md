...
**Exercise 401.** [*16*] [16] If $z$ has the unary representation $z^1 z^2 \ldots z^{d-1}$, what is the unary representation of (a) $y = \lfloor z/2 \rfloor$? (b) $z = \lfloor (x+1)/3 \rfloor$?
