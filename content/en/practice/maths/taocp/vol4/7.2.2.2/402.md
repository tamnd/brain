...
**Exercise 402.** [*18*] *[18]* If $z$ has the $n$-ary representation $x^1 2^2 \cdots z^{d-1}$, encode the further condition that $x$ is (a) even; (b) odd.
