...
**Exercise 416.** [*20*] [20] Encode the condition: if $x_1 \ldots x_n = y_1 \ldots y_n$ then $a_1 \ldots a_m = v_1 \ldots v_m$, using $2m + 2n + 1$ clauses and $n + 1$ auxiliary variables. *Hint:* 2n of the clauses are in (172).
