...
**Exercise 410.** [*24*] [24] Exhibit clauses for the constraint $13x - 8y \le 7$ when $x$ and $y$ are *log-encoded* as 3-bit integers $x = (x_2 x_1 x_0)_2$ and $y = (y_2 y_1 y_0)_2$. (Compare with exercise 405(b).)
