---
title: "TAOCP 7.2.2.2 Exercise 340"
...
date: "2026-07-17T02:48:48+07:00"
...
**Exercise 340.** &#9654; [*M20*] If we assign a weight $w(\sigma)$ to every cyclic permutation $\sigma$, then every permutation $\pi$ has a weight $w(\pi)$ that is the product of the weights of its cycles. For example, if $\pi = \binom{1\,2\,3\,4\,5\,6\,7}{5\,1\,4\,2\,7\,6\,3} = (1\,3\,4\,2)(5\,7)(6)$ then $w(\pi) = w((1\,3\,4\,2))w((5\,7))w((6))$.

The *permutation polynomial* of a set $S$ is the sum of $w(\pi)$ over all permutations of $S$. Given any $n \times n$ matrix $A = (a_{ij})$, show that it's possible to define appropriate cycle weights so that the permutation polynomial of $\{1, \ldots, n\}$ is the determinant of $A$.
