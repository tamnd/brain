---
title: "TAOCP 7.2.2.2 Exercise 346"
...
date: "2026-07-17T03:11:38+07:00"
...
**Exercise 346.** &#9654; [*HM28*] Write $(142)$ as $M_G = M_{G \setminus a}(1 - aK_{a,G})$ where $K_{a,G} = M_{G \setminus a^*} / M_{G \setminus a}$.

a) If $(p_1, \ldots, p_m) \in \mathcal{R}(G)$, prove that $K_{a,G}$ is monotonic in all of its parameters: It does not increase if any of $p_1, \ldots, p_m$ are decreased.
b) Exploit this fact to design an algorithm that computes $M_G(p_1, \ldots, p_m)$ and decides whether or not $(p_1, \ldots, p_m) \in \mathcal{R}(G)$, given a graph $G$ and probabilities $(p_1, \ldots, p_m)$. Illustrate your algorithm on the graph $G = P_5 \square P_2$ of exercise 335.
