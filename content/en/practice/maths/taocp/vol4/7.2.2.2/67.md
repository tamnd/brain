...
**Exercise 67.** [**] $[2\frac{1}{2}]$ Find a mobile chessboard path $X_0 \to X_1 \to \cdots \to X_{21}$ with no more than five cells alive in each $X_i$. (The glider in (37) leaves the board after $X_{20}$.) How about $X_{22}$?
