...
**Exercise 50.** [*24*] $[24]$ Demonstrate Larrabee's method of representing stuck-at faults by describing the clauses that characterize test patterns for the fault "$x_2^-$ stuck at 1" in Fig. 34. (This is the wire that splits off of $x_2$ and feeds into $x_2^3$ and $x_2^5$, then to $b_7$ and $b_5$; see Table 1.)
