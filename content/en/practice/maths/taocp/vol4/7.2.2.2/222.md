---
title: "TAOCP 7.2.2.2 Exercise 222"
description: "Let $F$ be a 7SAT instance."
date: "2026-07-16T13:49:08+07:00"
...
**Exercise 222.** [*M30*] *[M30]* (Oliver Kullmann, 2000.) Prove that, for every clause $C$ in a satisfiability problem $F$, there is an autarky satisfying $C$ if and only if $C$ cannot be used as the label of a source vertex in any resolution refutation of $F$.
