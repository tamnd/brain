...
**Exercise 77.** [*20*] "Step $X_{-1}$," which precedes $X_0$ in (38), has the glider configuration ▶ instead of ▼. What conditions on the still life $X_S$ will ensure that state $X_0$ is indeed reached? (We don't want digestion to begin prematurely.)
