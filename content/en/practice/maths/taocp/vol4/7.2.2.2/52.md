...
**Exercise 52.** [*15*] $[15]$ What clauses correspond to (29) and (30) when the *second* case on the left of Table 2, $f(1, 0, 1, 0, \ldots, 1) = 1$, is taken into account?
