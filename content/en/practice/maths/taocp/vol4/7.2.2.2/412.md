...
**Exercise 412.** [*40*] [40] Experiment with the encoding of somewhat large numbers by using a radix-$d$ representation in which each digit has the order encoding.
