...
**Exercise 81.** [*21*] Conway discovered a remarkable "spaceship," where $X_4$ is $X_0$ shifted up 2:

$$X_0 = \raisebox{0pt}{\includegraphics[height=1em]{fig_spaceship_x0}} \to \cdots \to X_4 = \raisebox{0pt}{\includegraphics[height=1em]{fig_spaceship_x4}}$$

Is there a left-right symmetrical version? (Such spaceships would eat any such spaceships?)
