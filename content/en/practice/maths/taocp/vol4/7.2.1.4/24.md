...
**Exercise 24.** [*M26*] [M26] (S. Ramanujan, 1919.) Let A(z) = ∞
k=1(1 −zk)4.
a) Prove that [zn] A(z) is a multiple of 5 when n mod 5 = 4.
b) Prove that [zn] A(z)B(z)5 has the same property, if B is any power series with
