---
title: "TAOCP 7.2.1.2 Exercise 70"
description: "Let $\\sigma$ and $\\tau$ be the two involutions on permutations of ${1,2,\\dots,n}$ given by adjacent transpositions on disjoint parity classes, in the standard TAOCP σ–τ framework, so that every step o..."
date: "2026-07-03T03:35:01+07:00"
...
**Exercise 70.** &#9654; [*M33*] [M33] The two 12-cycles (41) can be regarded as σ–τ cycles for the twelve per-
...
jumping from one to the other. Can a σ–τ path for all permutations of 6 elements be
