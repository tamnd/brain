---
title: "TAOCP 7.2.1.2 Exercise 75"
description: "Let $x \\in [0,1)$ and write its dyadic expansion x = 0."
date: "2026-07-02T15:16:02+07:00"
...
**Exercise 75.** [*M26*] [M26] The directed torus C⃗m×C⃗n has mn vertices (x, y) for 0 ≤x < m, 0 ≤y < n,
and arcs (x, y)−−→(x, y)α = ((x + 1) mod m, y), (x, y)−−→(x, y)β = (x, (y + 1) mod n).
