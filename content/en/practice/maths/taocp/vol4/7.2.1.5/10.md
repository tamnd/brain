---
title: "TAOCP 7.2.1.5 Exercise 10"
...
date: "2026-07-04T21:12:34+07:00"
...
**Exercise 10.** [*25*] [25] A *semilabeled tree* is an oriented tree in which the leaves are labeled with the integers $\{1, \ldots, k\}$, but the other nodes are unlabeled. There are thus 15 semilabeled trees with 5 vertices:

![Figure: semilabeled trees with 5 vertices](figure_semilabeled_trees.png)

Find a one-to-one correspondence between partitions of $\{1, \ldots, n\}$ and semilabeled trees with $n + 1$ vertices.
