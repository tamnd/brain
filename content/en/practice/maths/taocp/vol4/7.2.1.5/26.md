---
title: "TAOCP 7.2.1.5 Exercise 26"
description: "Let F_\\alpha(x_1,\\dots,x_m)=\\frac{1}{m!"
date: "2026-07-04T16:22:51+07:00"
...
**Exercise 26.** [*M2*] [M2] According to the recurrence equations (13), the numbers $\varpi_{nk}$ in Peirce's triangle count the paths from $\binom{0}{0}$ to $\binom{n}{k}$ in the infinite directed graph

![Figure: Peirce's triangle directed graph](figure_peirce_triangle.png)

Explain why each path from $\binom{0}{0}$ to $\binom{n}{k}$ corresponds to a partition of $\{1, \ldots, n\}$.
