---
title: "TAOCP 7.2.1.5 Exercise 32"
...
date: "2026-07-04T23:41:55+07:00"
...
**Exercise 32.** [*M22*] [M22] Let $\delta_n$ be the number of restricted growth strings $a_1 \ldots a_n$ for which the sum $a_1 + \cdots + a_n$ is even minus the number for which $a_1 + \cdots + a_n$ is odd. Prove that

$$\delta_n = (-1,\, 0,\, -1,\, 0,\, 1,\, 0) \quad \text{when } n \bmod 6 = (1,\, 2,\, 3,\, 4,\, 5,\, 0).$$

*Hint:* See exercise 28(c).
