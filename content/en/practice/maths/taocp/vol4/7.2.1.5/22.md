---
title: "TAOCP 7.2.1.5 Exercise 22"
...
date: "2026-07-04T22:47:06+07:00"
...
**Exercise 22.** [*M2*] [M2] If $X$ is a random variable with a given distribution, the expected value of $X^n$ is called the $n$th *moment* of that distribution. What is the $n$th moment when $X$ is (a) a Poisson deviate with mean 1 [Eq. 3.4.1–(40)]? (b) the number of fixed points of a random permutation of $\{1, \ldots, m\}$, when $m \ge n$ [Eq. 1.3.3–(27)]?
