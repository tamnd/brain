---
title: "TAOCP 7.2.1.5 Exercise 45"
...
date: "2026-07-05T00:55:24+07:00"
...
**Exercise 45.** &#9654; [*HM23*] Show that, in addition to (26), we also have the expansion

$$\varpi_n = \frac{e^{e^t - 1}}{t^n \sqrt{2\pi(t+1)}} \Biggl( 1 + \frac{b_1'}{n} + \frac{b_2'}{n^2} + \cdots + \frac{b_m'}{n^m} + O\!\left(\frac{1}{n^{m+1}}\right) \Biggr),$$

where $b_1' = -(2t^4 + 9t^3 + 6t^2 + 6t + 2)/(24(t+1)^3)$.
