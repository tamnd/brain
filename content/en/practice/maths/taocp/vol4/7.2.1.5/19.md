---
title: "TAOCP 7.2.1.5 Exercise 19"
...
date: "2026-07-04T22:29:47+07:00"
...
**Exercise 19.** [*28*] Prove that there is a Gray code for restricted growth strings in which, at each step, some $a_j$ changes by either $\pm 1$ or $\pm 2$, when (a) we want to generate all $\varpi_n$ strings $a_1 \ldots a_n$; or (b) we want to generate only the $\binom{n}{m}$ cases with $\max(a_1, \ldots, a_n) = m-1$.
