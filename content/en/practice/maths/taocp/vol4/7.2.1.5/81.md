---
title: "TAOCP 7.2.1.5 Exercise 81"
...
date: "2026-07-04T21:05:46+07:00"
...
**Exercise 81.** [*29*] Find a way to arrange an ordinary deck of 52 playing cards so that the following trick is possible: Five players each cut the deck (applying a cyclic permutation) as often as they like. Then each player takes a card from the top. A magician tells them to look at their cards and to form affinity groups, joining with others who hold the same suit: Everybody with clubs gets together, everybody with diamonds forms another group, and so on. (The Jack of Spades is, however, considered to be a "joker"; its holder, if any, should remain aloof.)

Observing the affinity groups, but not being told any of the suits, the magician can name all five cards, if the cards were suitably arranged in the first place.
