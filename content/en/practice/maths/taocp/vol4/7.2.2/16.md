...
date: "2026-07-05T08:57:44+07:00"
...
**Exercise 16.** [*21*] [21] Let $H(n)$ be the number of ways of keeping $n$ bees in a honeycomb so that no two are in the same line. (For example, the value of $H(4) = 7$ ways is shown here.) Compute $H(n)$ for small $n$.
