---
title: "TAOCP 7.2.1.6 Exercise 16"
...
date: "2026-07-05T00:57:32+07:00"
...
**Exercise 16.** [*20*] [20] If $F$ and $G$ are forests, let $FG$ be the forest obtained by placing the trees of $F$ to the left of the trees of $G$; also let $F\{G = (G^T F^T)^T\}$. Give an intuitive explanation of the operator $\{$, and prove that it is associative.
