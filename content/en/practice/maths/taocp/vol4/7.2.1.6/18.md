---
title: "TAOCP 7.2.1.6 Exercise 18"
...
date: "2026-07-05T07:22:05+07:00"
...
**Exercise 18.** [*30*] [30] Two forests are said to be *cognate* if one can be obtained from the other by repeated operations of taking the conjugate and/or the transpose. The examples in exercises 11 and 12 show that all forests on 4 nodes belong to one of three cognate classes:

$$\bullet \bullet \bullet \bullet = \begin{cases} \uparrow \\ \end{cases}, \quad \underset{\displaystyle\uparrow}{\uparrow} \times = \begin{cases} \uparrow\uparrow \end{cases}, \quad \overset{\displaystyle\uparrow}{\uparrow} = \begin{cases} \uparrow \\ \uparrow \end{cases}, \quad \overset{\displaystyle\uparrow}{\uparrow} \times = \begin{cases} \uparrow \end{cases}$$

$$\uparrow \times \overset{\uparrow}{\uparrow} \times \overset{\uparrow\uparrow}{\uparrow} \times \overset{\uparrow}{\uparrow} \times \overset{\uparrow}{\uparrow} \times \bullet$$

Study the set of all forests with 15 nodes. How many equivalence classes of cognate forests do they form? What is the largest class? What is the smallest class? What is the size of the class containing $\{\downarrow\}$?
