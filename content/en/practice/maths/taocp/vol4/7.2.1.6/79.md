---
title: "TAOCP 7.2.1.6 Exercise 79"
...
date: "2026-07-05T05:59:39+07:00"
...
**Exercise 79.** [*M26*] [M26] The number of permutations $p_1 \ldots p_n$ that have exactly one "descent" where $p_k > p_{k+1}$, is the Eulerian number $\langle {n \atop 1} \rangle = 2^n - n - 1$, according to Eq. 5.1.3–(12). The number of entries in the Christmas tree pattern, above the bottom row, is the same.
