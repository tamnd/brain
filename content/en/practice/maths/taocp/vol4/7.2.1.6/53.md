---
title: "TAOCP 7.2.1.6 Exercise 53"
...
date: "2026-07-05T03:51:21+07:00"
...
**Exercise 53.** [*M28*] $[M28]$ Let $X$ be the distance from the root of an extended binary tree to the leftmost external node. (a) What is the expected value of $X$, when all binary trees with $n$ nodes are equally likely? (b) What is the expected value of $X$ in a random *binary search tree*, constructed by Algorithm 6.2.2T from a random permutation $K_1 \ldots K_n$? (c) What is the expected value of $X$ in a random *degenerate* binary tree, in the sense of exercise 31? (d) What is the expected value of $2^X$ in all three cases?
