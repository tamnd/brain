---
title: "TAOCP 7.2.1.6 Exercise 118"
...
date: "2026-07-05T06:04:56+07:00"
...
**Exercise 118.** [*M28*] [M28] How many lucky nodes are present in (a) the complete $t$-ary tree with $(t^k - 1)/(t - 1)$ internal nodes? (b) the Fibonacci tree of order $k$, with $F_{k+1} - 1$ internal nodes? (See 2.3.4.5–(6) and Fig. 8 in Section 6.2.1.)
