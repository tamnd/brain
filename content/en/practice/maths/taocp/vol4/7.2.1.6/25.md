---
title: "TAOCP 7.2.1.6 Exercise 25"
...
date: "2026-07-05T01:42:49+07:00"
...
**Exercise 25.** &#9654; [*20*] [20] *(Pruning and grafting.)* Representing binary trees as in Algorithm B, design an algorithm that visits all link tables $l_0 \ldots l_n$ and $r_1 \ldots r_n$ in such a way that, between visits, exactly one link changes from $j$ to 0 and another from 0 to $j$, for some index $j$. (In other words, every step removes some subtree $j$ from the binary tree and places it elsewhere, preserving preorder.)
