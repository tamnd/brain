---
title: "TAOCP 7.2.1.6 Exercise 82"
...
date: "2026-07-05T13:20:12+07:00"
...
**Exercise 82.** &#9654; [*M26*] Let $E(f)$ be the number of times Algorithm II evaluates the function $f$.

a) Show that $M_n \le E(f) \le M_{n+1}$, with equality when $f$ is constant.

b) Among all $f$ such that $E(f) = M_n$, which one minimizes $\sum_{\sigma} f(\sigma)$?

c) Among all $f$ such that $E(f) = M_n$, which one maximizes $\sum_{\sigma} f(\sigma)$?
