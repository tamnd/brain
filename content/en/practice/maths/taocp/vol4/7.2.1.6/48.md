---
title: "TAOCP 7.2.1.6 Exercise 48"
...
date: "2026-07-05T03:29:45+07:00"
...
**Exercise 48.** [*M28*] $[M28]$ (Ruskey and Savage.) Prove that $C_{nn}(z) = (1+z)^{2n}/(1+z^{n+1}) - 1$, and use this result to show that no "perfect" Gray code for nested parentheses is possible when $n \ge 5$ is odd.
