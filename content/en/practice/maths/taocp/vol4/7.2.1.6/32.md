---
title: "TAOCP 7.2.1.6 Exercise 32"
...
date: "2026-07-05T08:44:02+07:00"
...
**Exercise 32.** &#9654; [*M30*] *[M30]* Prove that if $F \dashv F'$, there is a forest $F''$ such that for all $G$ we have

$$F' \sqcup G = F \quad \text{if and only if} \quad F \sqcap G \dashv F'.$$

Consequently the *semidistributive laws* hold in the Tamari lattice:

$$F \sqcap G = F \sqcap H \quad \text{implies} \quad F \sqcap (G \sqcup H) = F \sqcap G;$$
$$F \sqcup G = F \sqcup H \quad \text{implies} \quad F \sqcup (G \sqcap H) = F \sqcup G.$$

![Figure 62: The Stanley lattice of order 4. Each forest is represented by its sequence of node depths in preorder. (See exercises 26–28.)](figure_62.png)
