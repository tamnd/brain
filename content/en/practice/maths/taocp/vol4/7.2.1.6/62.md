---
title: "TAOCP 7.2.1.6 Exercise 62"
...
date: "2026-07-05T04:36:28+07:00"
...
**Exercise 62.** [*22*] [22] A binary tree can also be specified by its right subtree bit strings $(l_j, r_j, r_1, \ldots, r_s)$, where $l_j$ and $r_j$ tell whether the left and right subtrees of node $j$ in preorder are nonempty. (See Theorem 2.3.1A.) Prove that if $l_1, l_s \ldots r_1, r_s$ is an arbitrary bit string where with $l_1 + \cdots + l_s + r_1 + \cdots + r_s = n - 1$, exactly one cyclic shift $(l_{j+1}, l_{j+1} \ldots l_s, r_1 \ldots l_1, r_{j+1} \ldots r_s r_1 \ldots r_j)$ yields a valid binary tree representation, and explain how to find it.
