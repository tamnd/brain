---
title: "TAOCP 7.2.1.6 Exercise 34"
...
date: "2026-07-05T02:25:37+07:00"
...
**Exercise 34.** [*M25*] (R. P. Stanley.) Show that the number of maximal chains in the Stanley lattice of order $n$ is $(n(n-1)/2)!/(1^{n-1}3^{n-2}\cdots(2n-3)^1(2n-3)!)$.
