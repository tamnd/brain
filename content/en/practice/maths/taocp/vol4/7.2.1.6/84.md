---
title: "TAOCP 7.2.1.6 Exercise 84"
...
date: "2026-07-05T06:22:54+07:00"
...
**Exercise 84.** &#9654; [*HM27*] (D. Kleitman.) Let $A$ be an $m \times n$ matrix of real numbers in which every column $v$ has length $\|v\| \ge 1$, and let $b$ be an $m$-dimensional column vector. Prove that at most $M_n$ column vectors $x = (a_1, \ldots, a_n)^T$, with components $a_j = 0$ or $1$, satisfy $\|Ax - b\| < \frac{1}{2}$. *Hint:* Use a construction analogous to the Christmas tree pattern.
