---
title: "TAOCP 7.2.1.6 Exercise 56"
...
date: "2026-07-05T04:06:35+07:00"
...
**Exercise 56.** [*M25*] $[M25]$ (Rényi–Szpankowski, 1990.) Prove the summation formula

$$\sum_{k=0}^{m} C_k C_{n-1-k} = \frac{2n-m}{2n(n+1)} \binom{2n}{m} \binom{2n-2m}{n-m}, \quad \text{for } 0 \le m \le n.$$
