---
title: "TAOCP 7.2.1.6 Exercise 40"
...
date: "2026-07-05T02:55:36+07:00"
...
**Exercise 40.** [*M25*] (a) Prove that $C_{pq}$ is odd if and only if $p\ \&\ (q+1) = 0$, in the sense that the binary representations of $p$ and $q+1$ have no bits in common. (b) Therefore $C_n$ is odd if and only if $n+1$ is a power of 2.
