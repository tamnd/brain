...
description: "Solution to Project Euler Problem 405."
...
$$f(n)
=
\frac{(-1)^{n+1}-5\cdot 2^{n+2}+6\cdot 4^n}{15}+1.$$
...
$$f(4)
=
\frac{-1-5\cdot 64+6\cdot 256}{15}+1
=
\frac{1215}{15}+1
=
82.$$
...
$$10^{18}\pmod{\varphi(17^6)}
=
10^{18}\pmod{16\cdot17^5}.$$

Then compute

$$N \equiv 10^{\,10^{18}\bmod(16\cdot17^5)}
\pmod{16\cdot17^6}.$$
...
$$\frac{-1-5\cdot2^{N+2}+6\cdot4^N}{15}+1
\pmod{17^7}.$$
