...
$$S(n,k,b)=\#\left\{(x_1,\dots,x_k)\in \mathbb Z_{\ge 0}^k:
x_1+\cdots+x_k\le n,\;\;0\le x_m\le b^m
\right\}.$$
...
$$S(n,k,b)
=
\sum_{A\subseteq \{1,\dots,k\}}
(-1)^{|A|}
\binom{
n-\sum_{i\in A}(b^i+1)+k
}{k}.$$
...
$$S(1000,10,5)\bmod 1{,}000{,}000{,}007
=
624839075$$
