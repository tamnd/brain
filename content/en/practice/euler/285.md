...
description: "Albert chooses a positive integer , then two real numbers are randomly chosen in the interval with uniform distribution."
...
$$A(R)=\int_1^{\sqrt{R^2-1}}
\left(\sqrt{R^2-x^2}-1\right)\,dx.$$
