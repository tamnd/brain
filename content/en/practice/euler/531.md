...
description: "Let g(a, n, b, m) be the smallest non-negative solution x to the system: x = a bmod n x = b bmod m if such a solution ex"
...
$$x\equiv \phi(n)\pmod n,\qquad x\equiv \phi(m)\pmod m.$$
