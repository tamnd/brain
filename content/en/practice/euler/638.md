...
description: "Let P{a,b} denote a path in a atimes b lattice grid with following properties: - The path begins at (0,0) and ends at (a"
...
$$C(a,b,k) = \binom{a+b}{a}_k = \prod_{i=1}^{a} \frac{k^{b+i}-1}{k^i-1}.$$
