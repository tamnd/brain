...
description: "Consider the following recurrence relation: $$\begin{align} a0 &= \frac{\sqrt 5 + 1}2\\ a{n+1} &= \dfrac{an(an^4 + 10an^"
...
$$p_n=\frac{F_{3\cdot 5^n}}2,\qquad
q_n=\frac{L_{3\cdot 5^n}}2,$$

and therefore

$$s(n)=p_n^5+q_n^5
=\frac{F_{3\cdot 5^n}^5+L_{3\cdot 5^n}^5}{32}.$$
