...
description: "Writing down the numbers which have a digit sum of 10 in ascending order, we get: Let be the occurrence of the digit sum"
...
$$S(k)=\sum_{n=1}^k f(n^3,n^4),
\qquad
S(10000)\pmod{1\,000\,000\,007}.$$
...
$$N
=
\sum_{i=0}^{L-1}(9-c_i)10^{L-1-i}
=
10^L-1-\sum_{i=0}^{L-1} c_i10^{L-1-i}.$$
