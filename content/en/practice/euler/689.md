...
description: "For $0 \le x \lt 1$, define $di(x)$ to be the $i$th digit after the binary point of the binary representation of $x$."
...
$$S_n=\sum_{i=1}^n \frac{X_i}{i^2},
\qquad
R_n=\sum_{i=n+1}^{\infty}\frac1{i^2}.$$
