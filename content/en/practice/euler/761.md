...
$$V_{Hexagon} = \max_{P\in\partial H}
\frac{d_{\partial}(R,P)}{|OP|}$$
...
$$P(t)=\left(\frac12-t,\frac{\sqrt3}{2}\right),
\quad 0\le t\le1$$
...
$$d_{\partial}(R,P)=\frac12+1+t
=\frac32+t$$

Now compute the swimmer distance:

$$|OP(t)|^2
=\left(\frac12-t\right)^2+\frac34$$
...
$$f'(t)=
(t^2-t+1)^{-3/2}
\left[(t^2-t+1)-\frac12(t+3/2)(2t-1)\right]$$
...
$$\frac{49}{64}-\frac{56}{64}+\frac{64}{64}
=\frac{57}{64}$$
...
$$V_n = 2n\sin\left(\frac{\pi}{2n}\right)
\cdot
\max_{0\le x\le1}
\frac{1+x}{\sqrt{1+x^2-2x\cos(\pi/n)}}$$

For the hexagon $(n=6)$,

$$V_6 = 12\sin\left(\frac{\pi}{12}\right)
\cdot
\max_{0\le x\le1}
\frac{1+x}{\sqrt{1+x^2-\sqrt3 x}}$$
...
$$V_{Circle}\approx 4.60
<
V_{Square}\approx 5.79
<
V_{Hexagon}\approx 6.39$$
