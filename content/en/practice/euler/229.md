...
description: "Consider the number . It is very special, because Similarly, we find that . In 1747, Euler proved which numbers are repr"
...
$$\sum_{\substack{d\le N\\ d\text{ squarefree}\\ p\mid d\Rightarrow p\in\mathcal P}}
\left\lfloor \sqrt{\frac{N}{d}} \right\rfloor .$$
