...
description: "For a set of positive integers , let be the number of non-empty subsets in which the product of all elements is a perfec"
...
$$\prod_{x\in T} x \text{ is a square}
\iff
\sum_{x\in T} v(x)=0 \quad (\text{over }\mathbb F_2).$$
