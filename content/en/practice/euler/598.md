...
description: "Consider the number . There are five pairs of integers and () such that : , , , and . It can be seen that both and have"
...
$$\prod_{i=1}^{25} (x_i+1)
=
\prod_{i=1}^{25} (e_i-x_i+1).$$

Equivalently,

$$\prod_{i=1}^{25}
\frac{x_i+1}{e_i-x_i+1}
=1.$$
