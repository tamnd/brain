...
\left(
\frac{xyr}{3}
+\frac{x^3}{6}\operatorname{asinh}\frac{y}{x}
+\frac{y^3}{6}\operatorname{asinh}\frac{x}{y}
\right)
=r.$$
...
$$Q(x,y)=
\frac{x^4y}{24}\operatorname{asinh}\frac{y}{x}
+\frac{xy^4}{24}\operatorname{asinh}\frac{x}{y}
-\frac{x^4r}{60}
+\frac{x^2y^2r}{20}
-\frac{y^4r}{60}.$$
