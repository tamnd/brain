...
description: "Given the representation of a continued fraction alpha is a real number with continued fraction representation: alpha ="
...
$$\alpha=[2;\underbrace{1,\dots,1}_{2},2,\underbrace{1,\dots,1}_{3},2, \underbrace{1,\dots,1}_{5},2,\ldots]$$
