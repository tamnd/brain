...
description: "A standard deck of playing cards, which consists of thirteen ranks (Ace, Two, ..., Ten, King, Queen and Jack) each in fo"
...
$$p_t
=
\Pr(\text{a fixed set of }t\text{ ranks are perfect})
=
\frac{N_t}{52!/(4!)^{13}}.$$
...
$$\binom{13}{t}p_t
=
\mathbb E\!\left[\binom Xt\right].$$

Hence

$$\binom{13}{t}p_t
=
\sum_{k=t}^{13}\binom{k}{t}\Pr(X=k).$$
