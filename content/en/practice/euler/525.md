...
description: "An ellipse is given at its initial position by equation: The ellipse rolls without slipping along the axis for one compl"
...
$$r(t)=(a\cos t,\; b\sin t),
\qquad -\frac{\pi}{2}\le t\le \frac{3\pi}{2}.$$
...
-\frac{\pi}{2}
-\operatorname{atan2}
\!\left(\frac{\sin t}{b},\frac{\cos t}{a}\right).$$
