...
description: "Solution to Project Euler Problem 423."
...
$$S(50\,000\,000)=\sum_{n=1}^{50\,000\,000} C(n)
\pmod{1\,000\,000\,007}.$$
...
6D(n)
+
\binom{n-1}{p+1}5^{\,n-1-p}.$$

Using

$$\binom{n-1}{p+1}
=
\binom{n-1}{p}\frac{n-1-p}{p+1},$$
...
\binom{n}{p}5^{n-p}
=
B_n\cdot \frac{5n}{n-p}.$$

So

$$\boxed{
B_{n+1}=B_n\frac{5n}{n-p}
}$$
