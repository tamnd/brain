...
description: "How many -digit numbers (without leading zeros) are there such that no digit occurs more than three times in ?"
...
\frac{18!}{\prod a_i!}
-
\frac{17!}{(a_0-1)!\prod_{i=1}^9 a_i!}.$$

Factor the second term:

$$\frac{17!}{(a_0-1)!\prod_{i=1}^9 a_i!}
=
\frac{17!a_0}{\prod a_i!}.$$
...
$$\boxed{
\sum_{\substack{a_0+\cdots+a_9=18\\0\le a_i\le3}}
\frac{17!(18-a_0)}{a_0!a_1!\cdots a_9!}
}$$
