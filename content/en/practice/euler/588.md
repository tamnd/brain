...
$$P(x)^{2^m}
=
1+x^{2^m}+x^{2\cdot 2^m}+x^{3\cdot 2^m}+x^{4\cdot 2^m}.$$
...
$$\begin{aligned}
&17,35,107,227,667,1459,4179,8507,\\
&24667,53227,151387,307787,884107,\\
&1808507,5148007,10454267,30069067,61039067.
\end{aligned}$$
