...
description: "In the following equation , , and are positive integers."
...
=
\sum_{v=1}^{\sqrt L}
\sum_{\substack{v<s<2v\\ \gcd(v,s)=1}}
\left\lfloor \frac{L}{vs}\right\rfloor.$$

Use the standard identity

$$[\gcd(v,s)=1]
=
\sum_{d\mid \gcd(v,s)} \mu(d),$$
