...
$$F(n)=\min_{m\mid n,\ m>1}
\left(
q^{\,m-1}\,F\!\left(\frac{n}{m}\right)
\right),$$

where $q$ is the smallest prime whose image modulo $p$ has quotient-order $m$, i.e.

$$\frac{\operatorname{ord}_p(q)}
{\gcd(\operatorname{ord}_p(q),\,n/m)}
= m.$$
...
$$T(20)=1\cdot2\cdot8\cdot12\cdot162\cdot72\cdot384\cdot1568
=1348422598656,$$
