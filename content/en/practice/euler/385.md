...
description: "For any triangle in the plane, it can be shown that there is a unique ellipse with largest area that is completely insid"
...
$$s_1=z_1+z_2+z_3=0,
\qquad
s_2=z_1z_2+z_2z_3+z_3z_1=-39.$$

Hence every admissible triangle satisfies

$$z_1+z_2+z_3=0,
\qquad
z_1z_2+z_2z_3+z_3z_1=-39.$$
...
$$A(10^9)
=
12\cdot 250000000\cdot 250000001\cdot 500000001.$$
