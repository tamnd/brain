...
description: "For a positive integer define to be the number of strictly larger integers which can be formed by permuting the digits o"
...
$$S(k)
=
\sum_{\substack{c_0+\cdots+c_9=k\\ c_d\ge 0}}
\frac{P(P-1)}{2},$$
