...
$$g_a(x)=
\sum_{k\ge0}\sum_{j=0}^{\lfloor x-ka\rfloor}\binom{j+k}{k}.$$

Now use the hockey-stick identity:

$$\sum_{j=0}^{m}\binom{j+k}{k}
=
\binom{m+k+1}{k+1}.$$
...
=
\sum_{k\ge0}
\binom{\lfloor x-ka\rfloor+k+1}{k+1}.$$
...
$$\boxed{
G(n)=
\sum_{k=0}^{\lfloor\sqrt n\rfloor}
\binom{\lfloor n-k\sqrt n\rfloor+k}{k}
}.$$
...
=
\sum_{k=0}^{9}
\binom{\lfloor 90-k\sqrt{90}\rfloor+k}{k}
=
7564511,$$
