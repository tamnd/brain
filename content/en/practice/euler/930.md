...
description: "Given $n\ge 2$ bowls arranged in a circle, $m\ge 2$ balls are distributed amongst them."
...
=
\frac1m\left(
\sum_{i=1}^{m-1}\cos\frac{2\pi k_i}{n}
+
\cos\frac{2\pi (k_1+\cdots+k_{m-1})}{n}
\right).$$
