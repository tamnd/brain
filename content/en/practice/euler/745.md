...
$$S(N)=\sum_{n\le N} g(n)
     =\sum_{t\le \sqrt N} t^2 \cdot Q\!\left(\left\lfloor\frac N{t^2}\right\rfloor\right),$$
...
$$\sum_{k\le 10^7} J_2(k)\left\lfloor\frac{10^{14}}{k^2}\right\rfloor
\pmod{1\,000\,000\,007}.$$
