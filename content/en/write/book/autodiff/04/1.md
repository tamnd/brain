...
genui{"math_block_widget_always_prefetch_v2":{"content":"f(x)=\\sin(x^2+3x)"}}
...
genui{"math_block_widget_always_prefetch_v2":{"content":"y=f(g(h(x)))"}}
...
genui{"math_block_widget_always_prefetch_v2":{"content":"f'(x)\\approx\\frac{f(x+h)-f(x)}{h}"}}
