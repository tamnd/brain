...
genui{"math_block_widget_always_prefetch_v2":{"content":"D[f](x,a v+b w)=aD[f](x,v)+bD[f](x,w)"}}
...
genui{"math_block_widget_always_prefetch_v2":{"content":"D[g\\circ f](x,v)=D[g](f(x),D[f](x,v))"}}
