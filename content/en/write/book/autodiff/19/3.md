...
genui{"math_block_widget_always_prefetch_v2":{"content":"D(f \\circ g)(x)=Df(g(x))\\cdot Dg(x)"}}
...
genui{"math_block_widget_always_prefetch_v2":{"content":"\\delta(ab)=a\\delta(b)+b\\delta(a)"}}
