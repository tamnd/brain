...
This formula is important theoretically. It explains why determinants control invertibility and why entries of an inverse are ratios of determinants. The adjugate is the transpose of the cofactor matrix, and it satisfies the determinant identity above.
...
This is called cofactor expansion or Laplace expansion. It expresses a determinant in terms of smaller determinants.
...
These identities hold for every square matrix \(A\), whether or not \(A\) is invertible.
...
This formula is valid exactly when \(\det(A)\ne 0\). It gives a closed form for the inverse using determinants.
...
The identity also holds in general.
