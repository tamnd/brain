...
Thus every eigenvalue of a Hermitian matrix lies in \(\mathbb{R}\). This is one of the most important structural properties of Hermitian matrices.
...
This is the complex spectral theorem for Hermitian matrices. It is one of the central theorems of linear algebra. Hermitian matrices admit an orthonormal eigenbasis and are therefore unitarily diagonalizable.
...
This theorem characterizes normal matrices completely in terms of orthonormal diagonalization. A complex matrix is normal exactly when it can be diagonalized by a unitary similarity transformation.
