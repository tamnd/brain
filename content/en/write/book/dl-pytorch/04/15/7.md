...
description: "Standard self-attention compares every token with every other token. For a sequence of length $T$, this produces a $T \\times T$ attention matrix. The cost grows quadratically with sequence length."
