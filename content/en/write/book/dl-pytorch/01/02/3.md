---
title: "x + y fails because the tensors are on different devices."
weight: 3
---

## 2.3 Tensor Creation and Initialization
...
### 2.3.1 Creating Tensors from Python Data
...
### 2.3.2 Creating Tensors with a Fixed Shape
...
### 2.3.3 Shape-Like Tensor Creation
...
### 2.3.5 Reproducibility and Random Seeds
...
### 2.3.6 Devices: CPU, GPU, and Accelerators
...
### 2.3.7 Data Types During Creation
...
### 2.3.9 Why Initialization Matters
...
### 2.3.12 Initializing Embeddings
...
### 2.3.13 Initializing Normalization Layers
...
### 2.3.14 Custom Initialization Functions
...
### 2.3.15 Initialization and Autograd
