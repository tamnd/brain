...
## 3.8 Automatic Differentiation Engines
...
### 3.8.1 Why Automatic Differentiation Matters
...
### 3.8.3 Leaf Tensors and Non-Leaf Tensors
...
### 3.8.7 Gradient Accumulation Semantics
...
### 3.8.8 Disabling Gradient Tracking
...
### 3.8.10 `backward()` and `autograd.grad`
...
### 3.8.11 Higher-Order Derivatives
...
### 3.8.12 Custom Autograd Functions
...
### 3.8.13 Gradient Checking for Custom Functions
...
### 3.8.15 Views, Copies, and Contiguity
